var OrgChart = function(t, e) {
    ...
    null != this.config.nodeMouseClickBehaviour && (this.config.nodeMouseClick = this.config.nodeMouseClickBehaviour), null != this.config.mouseScroolBehaviour && (this.config.mouseScrool = this.config.mouseScroolBehaviour), OrgChart._validateConfig(this.config) && (this.server = null, this._vScroll = {}, this.config.ui || (this.ui = OrgChart.ui), this.config.editUI ? this.editUI = this.config.editUI : this.editUI = new OrgChart.editUI, this.editUI.init(this), null === this.server && (this.server = new OrgChart.server(this.config)), this.config.searchUI ? this.searchUI = this.config.searchUI : this.searchUI = new OrgChart.searchUI, this.searchUI.init(this), this.config.nodeMenuUI ? this.nodeMenuUI = this.config.nodeMenuUI : this.nodeMenuUI = new OrgChart.menuUI, this.nodeMenuUI.init(this, this.config.nodeMenu), this.config.nodeContextMenuUI ? this.nodeContextMenuUI = this.config.nodeContextMenuUI : this.nodeContextMenuUI = new OrgChart.menuUI, this.nodeContextMenuUI.init(this, this.config.nodeContextMenu), this.config.toolbarUI ? this.toolbarUI = this.config.toolbarUI : this.toolbarUI = new OrgChart.toolbarUI, this.config.notifierUI ? this.notifierUI = this.config.notifierUI : this.notifierUI = new OrgChart.notifierUI, this.notifierUI.init(this), this.config.dragDropMenuUI ? this.dragDropMenuUI = this.config.dragDropMenuUI : this.dragDropMenuUI = new OrgChart.menuUI, this.dragDropMenuUI.init(this, this.config.dragDropMenu), this.config.menuUI ? this.menuUI = this.config.menuUI : this.menuUI = new OrgChart.menuUI, this.menuUI.init(this, this.config.menu), this.config.xScrollUI || (this.xScrollUI = new OrgChart.xScrollUI(this.element, this.config, function() {
        ...
        r._draw(!0, OrgChart.action.xScroll)
    })), this._gragStartedId = null, this._timeout = null, this._touch = null, this._initialized = !1, this.response = null, this.nodes = null, this._setInitialSizeIfNotSet(), 0 < this.config.nodes.length && this._draw(!1, OrgChart.action.init))
};
OrgChart.prototype.load = function(t) {
    ...
    for (var e = [], r = 0; r < this.config.nodes.length; r++) this.config.nodes[r].pid == t && e.push(JSON.parse(JSON.stringify(this.config.nodes[r])));
    return e
}, OrgChart.prototype._draw = function(t, v, x, y) {
    var b = this;
    this._hideBeforeAnimationCompleted = !1;
    var e = v == OrgChart.action.init ? null : this.getViewBox();
    this.server.read(t, this.width(), this.height(), e, v, x, function(t) {
        v != OrgChart.action.exporting && (b.nodes = t.nodes), b.editUI.fields = t.allFields;
        var e = {
            defs: ""
        };
        ...
        for (var n in OrgChart.events.publish("prerender", [b, e]), r = e.content, t.visibleNodes) {
            var l = t.visibleNodes[n],
                s = b._get(n);
            r += b.ui.node(l, s, t.animations, b.config, void 0, void 0, void 0, v, i, b), r += b.ui.link(l, b, b.config, i), r += b.ui.expandCollapse(l, b.config, v, i)
        }
        e = {
            content: r,
            res: t
        };
        if (OrgChart.events.publish("render", [b, e]), r = e.content, r += b.ui.lonely(b.config), v !== OrgChart.action.exporting) {
            v !== OrgChart.action.centerNode && v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update || (o = a), v === OrgChart.action.init && null != a && (o = a), b.response = t;
            O = b.ui.svg(b.width(), b.height(), o, b.config, r);
            if (b._initialized) {
                var h = b.getSvg(),
                    d = h.parentNode;
                d.removeChild(h), d.insertAdjacentHTML("afterbegin", O), b._attachEventHandlers(), b.xScrollUI.addListener(b.getSvg()), b.yScrollUI.addListener(b.getSvg()), b.xScrollUI.setPosition(), b.yScrollUI.setPosition()
            } else {
                b.element.innerHTML = b.ui.css() + b.ui.exportMenuButton(b.config) + O, b._attachInitEventHandlers(), b._attachEventHandlers(), b.xScrollUI.create(b.width(), b.config.padding), b.xScrollUI.setPosition(), b.xScrollUI.addListener(b.getSvg()), b.yScrollUI.create(b.height(), b.config.padding), b.yScrollUI.setPosition(), b.yScrollUI.addListener(b.getSvg()), b.config.enableSearch && b.searchUI.addSearchControl(), b.toolbarUI.init(b, b.config.toolbar);
            ...
            if (0 < p[0].length) {
                ...
                for (var f = 0; f < p[0].length; f++) p[0][f] = b.getNodeElement(p[0][f]);
                OrgChart.anim(p[0], p[1], p[2], b.config.anim.duration, b.config.anim.func, function() {
                    g || (y && y(), OrgChart.events.publish("redraw", [b]), b._showAfterAnimation(), g = !0)
                })
            }
            v === OrgChart.action.centerNode ? OrgChart.anim(b.getSvg(), {
                viewbox: a
            }, {
                viewbox: b.response.viewBox
            }, b.config.anim.duration, b.config.anim.func, function() {
                b.ripple(x.options.rippleId), g || (y && y(), OrgChart.events.publish("redraw", [b]), b._showAfterAnimation(), g = !0)
            }, function() {
                b.xScrollUI.setPosition(), b.yScrollUI.setPosition()
            }) : !a || !b.response || a[0] == b.response.viewBox[0] && a[1] == b.response.viewBox[1] && a[2] == b.response.viewBox[2] && a[3] == b.response.viewBox[3] || v !== OrgChart.action.insert && v !== OrgChart.action.expandCollapse && v !== OrgChart.action.update && v !== OrgChart.action.init ? 0 == p[0].length && (g || (y && y(), OrgChart.events.publish("redraw", [b]), g = !0)) : OrgChart.anim(b.getSvg(), {
                viewbox: a
            }, {
                viewbox: b.response.viewBox
            }, 500, OrgChart.anim.inOutPow, function() {
                b.xScrollUI.setPosition(), b.yScrollUI.setPosition(), g || (y && y(), OrgChart.events.publish("redraw", [b]), g = !0)
            }), b._initialized || (b._initialized = !0, OrgChart.events.publish("init", [b]))
        } else {
            var u = t.boundary,
                C = u.maxX - u.minX,
                m = u.maxY - u.minY,
    ...
    return t || (t = this.getViewBox()), OrgChart.getScale(t, this.width(), this.height(), this.config.scaleInitial)
    ...
    if (null != i) {
        ...
        if (null != a) {
            ...
            C.setAttribute("x", v.ripple.rect ? v.ripple.rect.x : 0), C.setAttribute("y", v.ripple.rect ? v.ripple.rect.y : 0), C.setAttribute("width", v.ripple.rect ? v.ripple.rect.width : i.w), C.setAttribute("height", v.ripple.rect ? v.ripple.rect.height : i.h), C.setAttribute("rx", v.ripple.radius), C.setAttribute("ry", v.ripple.radius), m.setAttribute("clip-path", "url(#" + O + ")"), m.setAttribute("cx", n), m.setAttribute("cy", l), m.setAttribute("r", 0), m.setAttribute("fill", v.ripple.color), u.appendChild(C), f.appendChild(u), f.appendChild(m), a.appendChild(f), OrgChart.anim(m, {
                r: 0,
                opacity: 1
            }, {
                r: p,
    ...
    var i, a, o = t,
        n = !0,
        l = !0;
    e && null != e.parentState && (i = e.parentState), e && null != e.childrenState && (a = e.childrenState), e && null != e.rippleId && (o = e.rippleId), e && null != e.vertical && (n = e.vertical), e && null != e.horizontal && (l = e.horizontal);
    var s = {
        parentState: i,
        childrenState: a,
        rippleId: o,
    ...
    OrgChart.events.removeForEventId(this._event_id), this.element.innerHTML = null
}, (BALKANGraph = OrgChart).prototype._canUpdateLink = function(t, e) {
    if (null == e || null == e) return !1;
    if (null == t || null == t) return !1;
    if (t == e) return !1;
    for (var r = this.getBGNode(t), i = !1, a = this.getBGNode(e).parent; null != a;) {
        if (a == r) {
            i = !0;
            break
        }
    ...
    if (this._canUpdateLink(t, e)) {
        ...
        r.isChildOfGroup && (this.removeNodeTag(r.id, r._groupParentNodeId), this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id));
        var l = this;
    ...
    var i = t.pid;
    return null != i && null != i && "" != i || (i = t.id), this._draw(!1, OrgChart.action.update, {
        id: i
    }, function() {
        r.ripple(t.id)
    }), !0
    ...
    var r = this.get(t.id);
    if (!0 === e && !1 === OrgChart.events.publish("update", [this, r, t])) return !1;
    for (var i = 0; i < this.config.nodes.length; i++) this.config.nodes[i].id == t.id && (this.config.nodes[i] = t);
    return !0
}, OrgChart.prototype.removeNode = function(t, e) {
    var r = this;
    return !1 !== this.remove(t, e) && (this._draw(!1, OrgChart.action.update, null, function() {
        r.config.sticky && OrgChart._moveToBoundaryArea(r.getSvg(), r.getViewBox(), r.response.boundary)
    }), !0)
}, OrgChart.prototype.remove = function(t, e) {
    var r = this.getBGNode(t);
    if ((r.isChildOfGroup && this._removeGroupIfHasOneNode(r._groupParentNodeId, r.id), !0 === e) && !1 === OrgChart.events.publish("remove", [this, t])) return !1;
    ...
    var i = this.getBGNode(t.pid),
        a = t.pid;
    return i && i.isChildOfGroup && (a = i._groupParentNodeId), this._draw(!1, r, {
        id: a,
        insertedNodeId: t.id
    }), !0
}, OrgChart.prototype.add = function(t, e) {
    if ((null == t.id && console.error("Call addNode without id"), !0 === e) && !1 === OrgChart.events.publish("add", [this, t])) return !1;
    return this.config.nodes.push(t), !0
}, OrgChart.prototype.addTag = function(t, e, r) {
    var i = OrgChart.copy(this.config.tags);
    if ((i[t] = e, !0 === r) && !1 === OrgChart.events.publish("updatetags", [this, i])) return !1;
    ...
    if ((delete r[t], !0 === e) && !1 === OrgChart.events.publish("updatetags", [this, r])) return !1;
    return this.config.tags = r, !0
}, OrgChart.prototype._updateTag = function(t, e, r) {
    var i = JSON.parse(JSON.stringify(this.config.tags));
    if (i[t][e] = r, !1 === OrgChart.events.publish("updatetags", [this, i])) return !1;
    this.config.tags = i;
    var a = this;
    this._draw(!1, OrgChart.action.update, {
        id: t
    ...
    var i = this.get(t);
    Array.isArray(i.tags) || (i.tags = []), -1 == i.tags.indexOf(e) && (i.tags.push(e), this.update(i, r))
}, OrgChart.prototype.removeNodeTag = function(t, e, r) {
    var i = this.get(t);
    if (Array.isArray(i.tags)) {
        var a = i.tags.indexOf(e); - 1 != a && (i.tags.splice(a, 1), this.update(i, r))
    }
...
}, OrgChart.prototype.groupNode = function(t, e, r) {
    var i = this,
        a = this.group(t, e, r);
    this._draw(!1, OrgChart.action.update, {
        id: a.id
...
}, OrgChart.prototype.group = function(t, e, r) {
    if (!0 === r && !1 === OrgChart.events.publish("group", [this, t, e])) return !1;
    var i = this.getBGNode(t),
        a = this.getBGNode(e),
        o = a.id;
    if (i.isGroup || a.isGroup || i.isChildOfGroup || a.isChildOfGroup)
        if (i.isGroup || a.isGroup || !i.isChildOfGroup || a.isChildOfGroup)
            if (i.isGroup || a.isGroup || i.isChildOfGroup || !a.isChildOfGroup)
                if (!i.isGroup && !a.isGroup && i.isChildOfGroup && a.isChildOfGroup) this._removeGroupIfHasOneNode(i._groupParentNodeId, i.id), this.removeNodeTag(i.id, i._groupParentNodeId, !0), this.addNodeTag(i.id, a._groupParentNodeId, !0), this.link(i.id, a.pid);
                else if (!i.isGroup && a.isGroup && i.isChildOfGroup && !a.isChildOfGroup) this._removeGroupIfHasOneNode(i._groupParentNodeId, i.id), this.removeNodeTag(i.id, i._groupParentNodeId, !0), this.addNodeTag(i.id, a.id, !0);
    else if (i.isGroup || !a.isGroup || i.isChildOfGroup || a.isChildOfGroup) {
        if (i.isGroup && a.isGroup && !i.isChildOfGroup && !a.isChildOfGroup)
            for (var n = 0; n < i.bgnodes.length; n++) this.removeNodeTag(i.bgnodes[n].id, i.id, !0), this.addNodeTag(i.bgnodes[n].id, a.id, !0)
    } else this.addNodeTag(i.id, a.id, !0);
    else this.addNodeTag(i.id, a._groupParentNodeId, !0), this.link(i.id, a.pid);
    else {
        l = OrgChart._randomId();
        this.addTag(l, {
            group: !0,
            groupName: "",
            groupState: OrgChart.EXPAND,
            template: "group_grey"
        }, !0), this._removeGroupIfHasOneNode(i._groupParentNodeId, i.id), this.removeNodeTag(i.id, i._groupParentNodeId, !0), this.addNodeTag(i.id, l, !0), this.addNodeTag(a.id, l, !0)
    } else {
        var l = OrgChart._randomId();
        this.addTag(l, {
            group: !0,
            groupName: "",
            groupState: OrgChart.EXPAND,
            template: "group_grey"
        }, !0), this.addNodeTag(i.id, l, !0), this.addNodeTag(a.id, l, !0);
        var s = this._get(a.id).pid;
        this.link(i.id, s)
    }
    return {
        rippleId: i.id,
    ...
    o.onload = function(t) {
        o.readyState == XMLHttpRequest.DONE && 200 === this.status && a(t.target.response)
    }, o.onerror = function(t) {
        a({
            error: t
        })
    }, o.open(e, t), o.responseType = i, o.setRequestHeader("Content-Type", "application/json"), null == r ? o.send() : o.send(r)
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.anim = function(c, g, p, f, u, C, m) {
    var O, v = 1,
        x = f / 10 + 1;
    document.getElementsByTagName("g");
    Array.isArray(c) || (c = [c]), Array.isArray(g) || (g = [g]), Array.isArray(p) || (p = [p]), O = setInterval(function() {
                ...
                switch (e.toLowerCase()) {
                    case "d":
                        var a = u((10 * v - 10) / f) * (p[t][e][0] - g[t][e][0]) + g[t][e][0],
                            o = u((10 * v - 10) / f) * (p[t][e][1] - g[t][e][1]) + g[t][e][1];
                        c[t].setAttribute("d", c[t].getAttribute("d") + " L" + a + " " + o);
                        break;
                    case "r":
                    ...
                    case "transform":
                        if (p[t][e]) {
                            ...
                            c[t].hasAttribute("transform") ? c[t].setAttribute("transform", "matrix(" + h.toString() + ")") : c[t].style.transform = "matrix(" + h.toString() + ")"
                        }
                        break;
                    case "viewbox":
                        if (p[t][e]) {
                    ...
                    case "margin":
                        ...
                        break;
                    default:
                        n = u((10 * v - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t] && c[t].style && (c[t].style[e] = n + r)
                }
            }
        m && m(), 1 + x < (v += 1) && (clearInterval(O), C && C(c))
    }, 10)
    ...
    t = this.getSvg();
    this.config.enableTouch || /Mobi/i.test(navigator.userAgent) || /Android/i.test(navigator.userAgent) ? (this._addEvent(t, "touchstart", this._globalMouseDownHandler), this._addEvent(t, "touchend", this._globalClickHandler)) : (this._addEvent(t, "mousedown", this._globalMouseDownHandler), this._addEvent(t, "click", this._globalClickHandler), this._addEvent(t, "contextmenu", this._globalContextHandler), this._addEvent(t, "dblclick", this._globalDbClickHandler), this.config.mouseScrool == OrgChart.action.zoom && (this._addEvent(t, "DOMMouseScroll", this._mouseScrollHandler), this._addEvent(t, "mousewheel", this._mouseScrollHandler)));
    ...
    var a, o;
    (i || (i = ""), e.getListenerList || (e.getListenerList = {}), e.getListenerList[t + i]) || (a = this, o = r, r = function() {
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.VERSION = "6.0.2", OrgChart.orientation = {}, OrgChart.orientation.top = 0, OrgChart.orientation.bottom = 1, OrgChart.orientation.right = 2, OrgChart.orientation.left = 3, OrgChart.orientation.top_left = 4, OrgChart.orientation.bottom_left = 5, OrgChart.orientation.right_top = 6, OrgChart.orientation.left_top = 7, OrgChart.CENTER = 8, OrgChart.ORIENTATION = 9, OrgChart.TEXT_THRESHOLD = 150, OrgChart.IMAGES_THRESHOLD = 70, OrgChart.LINKS_THRESHOLD = 150, OrgChart.EXPCOLL_THRESHOLD = 40, OrgChart.ANIM_THRESHOLD = 50, OrgChart.ID = "id", OrgChart.PID = "pid", OrgChart.TAGS = "tags", OrgChart.NODES = "nodes", OrgChart.ELASTIC = "elastic", OrgChart.MAX_DEPTH = 100, OrgChart.SCALE_FACTOR = 1.44, OrgChart.EXPAND = 0, OrgChart.COLLAPSE = 1, OrgChart.LAZY_LOADING_FACTOR = 500, OrgChart.action = {}, OrgChart.action.expandCollapse = 0, OrgChart.action.groupMaxMin = 100, OrgChart.action.edit = 1, OrgChart.action.zoom = 2, OrgChart.action.scroll = 41, OrgChart.action.xScroll = 3, OrgChart.action.yScroll = 4, OrgChart.action.none = 5, OrgChart.action.init = 6, OrgChart.action.update = 7, OrgChart.action.pan = 8, OrgChart.action.centerNode = 9, OrgChart.action.resize = 10, OrgChart.action.insert = 11, OrgChart.action.insertfirst = 12, OrgChart.action.details = 13, OrgChart.action.exporting = 14, OrgChart.none = 400001, OrgChart.scroll = {}, OrgChart.scroll.visible = 1, OrgChart.scroll.smooth = 12, OrgChart.scroll.speed = 120, OrgChart.scroll.safari = {
    smooth: 12,
    speed: 250
}, OrgChart.match = {}, OrgChart.match.height = 100001, OrgChart.match.width = 100002, OrgChart.match.boundary = 100003, OrgChart.COLLAPSE_PARENT_NEIGHBORS = 1, OrgChart.COLLAPSE_SUB_CHILDRENS = 2, OrgChart.normal = 0, OrgChart.mixed = 1, OrgChart.tree = 2, OrgChart.treeLeftOffset = 3, OrgChart.treeRightOffset = 4, OrgChart.nodeOpenTag = '<g node-id="{id}" style="opacity: {opacity}" transform="matrix(1,0,0,1,{x},{y})" class="{class}" level="{level}">', OrgChart.linkOpenTag = '<g link-id="[{id}][{child-id}]" class="{class}" level="{level}">', OrgChart.expcollOpenTag = '<g control-expcoll-id="{id}" transform="matrix(1,0,0,1,{x},{y})"  style="cursor:pointer;">', OrgChart.groupNodesOpenTag = '<g transform="matrix(1,0,0,1,{x},{y})">', OrgChart.linkFieldsOpenTag = '<g transform="matrix(1,0,0,1,{x},{y}) rotate({rotate})">', OrgChart.grCloseTag = "</g>", OrgChart.IT_IS_LONELY_HERE = '<g transform="translate(-100, 0)" style="cursor:pointer;"  control-add="control-add"><text fill="#E68E58">{link}</text></g>', OrgChart.RES = {}, OrgChart.RES.IT_IS_LONELY_HERE_LINK = "It's lonely here, add your first node", OrgChart.MAXIMIZE = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,{x},20)" control-maxmin-id="{id}"><rect x="0" y="0" width="26" height="26" fill="#EEEEEE" stroke="#aeaeae" stroke-width="1" rx="2"></rect><polyline  stroke="#aeaeae" stroke-width="2" points="9,6 17,13 9,20" fill="none"></polyline></g>', OrgChart.MINIMIZE = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,{x},20)" control-maxmin-id="{id}"><rect x="0" y="0" width="26" height="26" fill="#EEEEEE" stroke="#aeaeae" stroke-width="1" rx="2"></rect><polyline stroke="#aeaeae" stroke-width="2" points="17,6 9,13 17,20" fill="none"></polyline></g>', OrgChart.MAX_NODES_MESS = "The trial has expired or 200 nodes limit was reached! <br /><a style='color: #E68E58;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>", OrgChart.OFFLINE_MESS = "The evaluation version requires intermet connection! <br /><a style='color: #E68E58;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>", OrgChart.SEARCH_PLACEHOLDER = "Search", OrgChart.A4w = 595, OrgChart.A4h = 842, OrgChart.A3w = 842, OrgChart.A3h = 1191, OrgChart.A2w = 1191, OrgChart.A2h = 1684, OrgChart.A1w = 1684, OrgChart.A1h = 2384, OrgChart.MIXED_LAYOUT_ALL_NODES = !0, OrgChart.CLINK_CURVE = 1, OrgChart.REMOVE_GROUP_IF_HAS_ONE_NODE = !0, "undefined" != typeof module && (module.exports = OrgChart.VERSION), OrgChart.input = function(t, e, r, i, a) {
    null == i && (i = !1);
    ...
    if (h.innerHTML = "Upload", h.style.position = "absolute", h.style.right = 0, o.style.margin = "14px 14px 7px 14px", o.style.textAlign = "left", o.style.position = "relative", o.setAttribute("data-field-name", t), s.style.border = "1px solid #d7d7d7", s.style.backgroundColor = "#d7d7d7", s.style.display = "block", s.style.width = "100%", n.style.color = "#bcbcbc", l.style.border = "none", l.style.outline = "none", l.style.width = "100%", l.setAttribute("val", ""), a && (l.style.width = "80%"), l.style.fontSize = "16px", l.readOnly = i, null != e && null != e && (l.value = e), null != r && null != r && (l.placeholder = r), null != t && null != t && (n.innerHTML = t), n.setAttribute("lbl", ""), l.style.color = "#7a7a7a", i || l.addEventListener("focus", function() {
            var t = this.parentNode.getElementsByTagName("hr")[0];
            t.style.border = "1px solid #E68E58", OrgChart.anim(t, {
                width: 10
            }, {
                width: o.clientWidth
            }, 250, OrgChart.anim.inOutSin)
        }), h.addEventListener("click", function() {
            var e = this,
                t = document.createElement("INPUT");
            t.setAttribute("type", "file"), t.style.display = "none", t.onchange = function() {
                var t = this.files[0];
                OrgChart.events.publish("imageuploaded", [t, e.parentNode.querySelector("input")])
            }, document.body.appendChild(t), t.click()
        }), l.addEventListener("blur", function() {
            this.parentNode.getElementsByTagName("hr")[0].style.border = "1px solid #d7d7d7"
        }), o.appendChild(n), o.appendChild(l), a && o.appendChild(h), o.appendChild(s), OrgChart.addValidation) {
        var d = {
            wrapper: o,
            label: n,
            input: l,
    ...
    switch (r.orientation) {
        ...
        case OrgChart.orientation.left_top:
            i = t.x, a = t.y - r.siblingSeparation / 4, o = t.x, n = t.y + t.h + r.siblingSeparation / 4
    }
    var l, s, h, d = e.p,
        c = e.q,
        g = e.r,
        p = e.s;
    return 0 != (l = (o - i) * (p - c) - (g - d) * (n - a)) && (s = ((a - n) * (g - i) + (o - i) * (p - a)) / l, 0 < (h = ((p - c) * (g - i) + (d - g) * (p - a)) / l) && h < 1 && 0 < s && s < 1)
    ...
    var o, n, l;
    return "left" == a ? o = t.leftNeighbor ? t.x + (t.leftNeighbor.x + t.leftNeighbor.w - t.x) / 2 : t.x - r.siblingSeparation / 2 : "right" == a && (o = t.rightNeighbor ? t.x + t.w + (t.rightNeighbor.x - (t.x + t.w)) / 2 : t.x + t.w + r.siblingSeparation / 2), e.push([o, e[e.length - 1][1]]), e.push([o, t.y - r.levelSeparation / 3]), n = e[e.length - 1][1], l = o, i.p = o, i.q = n, i.r = l, i
}, OrgChart._addPointBottom = function(t, e, r, i, a) {
    var o, n, l;
    return "left" == a ? o = t.leftNeighbor ? t.x + (t.leftNeighbor.x + t.leftNeighbor.w - t.x) / 2 : t.x - r.siblingSeparation / 2 : "right" == a && (o = t.rightNeighbor ? t.x + t.w + (t.rightNeighbor.x - (t.x + t.w)) / 2 : t.x + t.w + r.siblingSeparation / 2), e.push([o, e[e.length - 1][1]]), e.push([o, t.y + t.h + r.levelSeparation / 3]), n = e[e.length - 1][1], l = o, i.p = o, i.q = n, i.r = l, i
}, OrgChart._addPointLeft = function(t, e, r, i, a) {
    var o, n = e[e.length - 1][0];
    return "bottom" == a ? o = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (o = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], o]), e.push([
        [t.x - r.levelSeparation / 3], o
    ]), n = e[e.length - 1][0], s = o, i.p = n, i.q = o, i.s = s, i
}, OrgChart._addPointRight = function(t, e, r, i, a) {
    var o, n = e[e.length - 1][0];
    return "bottom" == a ? o = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (o = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2), e.push([e[e.length - 1][0], o]), e.push([
        [t.x + t.w + r.levelSeparation / 3], o
    ]), n = e[e.length - 1][0], s = o, i.p = n, i.q = o, i.s = s, i
    ...
    this.node = this.obj.getBGNode(t), this.wrapperElement = document.getElementById("bgEditForm"), this.wrapperElement && this.obj.element.removeChild(this.wrapperElement), this.wrapperElement = document.createElement("div"), this.wrapperElement.className = "edit-wrapper";
    ...
    n.className = "edit-tags", a.innerHTML = '<svg style="width: 34px; height: 34px;"><path style="fill:#ffffff;" d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111 C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587 c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path></svg>', Object.assign(a.style, {
        ...
        margin: "12px"
    }), this.wrapperElement.appendChild(e), e.appendChild(i), e.appendChild(o), o.appendChild(n), i.appendChild(a), OrgChart.htmlRipple(i);
    var l = this.fields,
        s = this.obj._get(t.id);
    t.isGroup && (l = ["Name"], s = {
        Name: this.obj.config.tags[t.id].groupName
    });
    for (var h = 0; h < l.length; h++) {
        var d = s[l[h]];
        if (t.isGroup && (d = this.obj.config.tags[t.id]["group" + l[h]]), OrgChart._fieldIsImg(this.obj.config, l[h])) {
            ...
            if (d)
                for (var g = 0; g < d.length; g++) {
                    ...
                    Object.assign(p.style, {
                        ...
                        "user-select": "none"
                    }), p.innerHTML = d[g], this._addField(n, p, d[g], "details-tag")
                }
        } else this._addField(o, OrgChart.input(l[h], d, null, !0), l[h], "details")
    }
    this.obj.element.appendChild(this.wrapperElement), i.addEventListener("click", function() {
        r.hide(!1)
    }), this.obj._hideBeforeAnimation(), OrgChart.anim(this.wrapperElement, {
        right: -150,
        opacity: 0
    }, {
        right: 0,
        ...
        r.obj._showAfterAnimation(), o.style.height = r.obj.element.offsetHeight - i.offsetHeight + "px"
    })
    ...
    for (var c = 0; c < h.length; c++) {
        var g = d[h[c]];
        if (t.isGroup && (g = this.obj.config.tags[t.id]["group" + h[c]]), "tags" != h[c])
            if (OrgChart._fieldIsImg(this.obj.config, h[c])) {
                ...
                this._addField(n, OrgChart.input(h[c], g, null, !1, !0), h[c], "edit")
            } else this._addField(n, OrgChart.input(h[c], g, null, !1), h[c], "edit")
    }
    t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || this._addField(n, l, "isAssistant", "edit"), t.isGroup || this._addField(n, o, "Add new field", "edit"), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function() {
        i.hide(!0)
    }), o.addEventListener("click", function() {
        if ("Save" == o.innerHTML) OrgChart.anim(o, {
            opacity: 1
        }, {
            opacity: 0
        }, 200, OrgChart.anim.inSin, function() {
            ...
            if (n.removeChild(t), e && !OrgChart._arrayContains(i.fields, e)) {
                var r = OrgChart.input(e);
                r.style.opacity = 0, n.insertBefore(r, o), OrgChart.anim(r, {
                    opacity: 0
                }, {
                    opacity: 1
                }, 200, OrgChart.anim.inSin, function() {
            ...
            OrgChart.anim(o, {
                ...
                o.innerHTML = "Save", o.style.textAlign = "right", OrgChart.anim(o, {
                    opacity: 0
                }, {
                    opacity: 1
                }, 200, OrgChart.anim.inSin)
            ...
            t.style.opacity = 0, t.id = "bgNewField", n.appendChild(t), OrgChart.anim(t, {
                opacity: 0
            }, {
                opacity: 1
            }, 200, OrgChart.anim.inSin, function() {
        ...
        i.obj._showAfterAnimation(), n.style.height = i.obj.element.offsetHeight - r.offsetHeight + "px", 1 < i.wrapperElement.getElementsByTagName("input").length && i.wrapperElement.getElementsByTagName("input")[0].focus()
    })
            ...
            for (var r = this.wrapperElement.querySelectorAll("[data-field-name]"), i = 0; i < r.length; i++) {
                ...
                if (a) {
                    ...
                    if (a === OrgChart.TAGS) e.tags = o.split(",");
                        ...
                        n && e.tags ? OrgChart._arrayContains(this.node.tags, "assistant") || e.tags.push("assistant") : n && !e.tags ? e.tags = ["assistant"] : !n && e.tags && -1 != this.node.tags.indexOf("assistant") && e.tags.splice(e.tags.indexOf("assistant"), 1)
                    } else null != e[a] ? e[a] = o : "" != o && (e[a] = o)
                }
            }
            var l = this;
            this.obj._hideBeforeAnimation(), OrgChart.anim(l.wrapperElement, {
                right: 0,
                opacity: 1
            }, {
                right: -150,
                ...
                l.obj._showAfterAnimation(), l.node.isGroup ? l.obj._updateTag(l.node.id, "groupName", e.Name) : l.obj.updateNode(e, !0), l.obj.element.removeChild(l.wrapperElement), l.wrapperElement = null
            })
    ...
    if ("" != r) {
        if (this.wrapper = document.createElement("div"), Object.assign(this.wrapper.style, {
                ...
                "text-align": "left",
                "user-select": "none"
            }), this.wrapper.style.left = "-99999px", this.wrapper.style.top = "-99999px", this.wrapper.innerHTML = r, this.obj.element.appendChild(this.wrapper), null == e) {
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
            (a = f[u]).addEventListener("mouseover", function() {
                ...
                if (void 0 === l[r].onClick)
                ...
                } else "remove" === r ? s.obj.removeNode(o, !0) : "svg" === r ? s.obj.exportSVG({
                    ...
                    expandChildren: !1,
                    nodeId: o
                }) : "csv" === r ? s.obj.exportCSV() : "xml" === r ? s.obj.exportXML() : "addInGroup" === r ? s.obj.groupNode(o, n) : "addAsChild" === r && s.obj.linkNode(o, n);
    ...
    keyPath: "id"
}, window.indexedDB = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB, OrgChart.idb.db = null, OrgChart.idb._open = function(e) {
    ...
    if (e) {
        ...
        }), e.expandAll && (this.div.innerHTML += '<div data-tlbr="expand">' + OrgChart.toolbarUI.expandAllIcon + "</div>"), e.fit && (this.div.innerHTML += '<div data-tlbr="fit">' + OrgChart.toolbarUI.fitIcon + "</div>"), e.zoom && (this.div.innerHTML += '<div data-tlbr="plus">' + OrgChart.toolbarUI.zoomInIcon + "</div>", this.div.innerHTML += '<div data-tlbr="minus">' + OrgChart.toolbarUI.zoomOutIcon + "</div>"), e.layout && (this.div.innerHTML += '<div data-tlbr="layout">' + OrgChart.toolbarUI.layoutIcon + "</div>", this.layouts = document.createElement("div"), this.layouts.innerHTML = '<svg data-layout="normal" style="cursor: pointer;" width="110" height="100"><rect fill="#E68E58" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="7" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="63" y="41" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="88" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="32" x2="32" y1="35" y2="41" stroke-width="1"></line><line stroke="#000000" x1="88" x2="88" y1="35" y2="41" stroke-width="1"></line></svg><svg data-layout="treeRightOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#E68E58" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="40" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="40" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="35" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="35" x2="35" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="35" x2="40" y1="54" y2="54" stroke-width="1"></line></svg><svg data-layout="treeLeftOffset" style="cursor: pointer;" width="110" height="100"><rect fill="#E68E58" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="30" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="30" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="35" stroke-width="1"></line><line stroke="#000000" x1="60" x2="85" y1="35" y2="35" stroke-width="1"></line><line stroke="#000000" x1="85" x2="85" y1="35" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="86" y2="86" stroke-width="1"></line><line stroke="#000000" x1="80" x2="85" y1="54" y2="54" stroke-width="1"></line></svg><svg data-layout="mixed" style="cursor: pointer;" width="110" height="100"><rect fill="#E68E58" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="35" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="35" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="41" stroke-width="1"></line><line stroke="#000000" x1="60" x2="60" y1="68" y2="73" stroke-width="1"></line></svg><svg data-layout="tree" style="cursor: pointer;" width="110" height="100"><rect fill="#E68E58" x="35" y="0" width="50" height="27"></rect><rect fill="#F57C00" x="7" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="7" y="73" width="50" height="27"></rect><rect fill="#F57C00" x="63" y="41" width="50" height="27"></rect><rect fill="#F57C00" x="63" y="73" width="50" height="27"></rect><line stroke="#000000" x1="60" x2="60" y1="27" y2="86" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="54" y2="54" stroke-width="1"></line><line stroke="#000000" x1="57" x2="63" y1="86" y2="86" stroke-width="1"></line></svg>', this.obj.element.appendChild(this.layouts), Object.assign(this.layouts.style, {
            position: "absolute",
            width: "100%",
            left: "0",
            bottom: "-145px",
        ...
        })), this.obj.element.appendChild(this.div), this.layoutBtn = this.div.querySelector('[data-tlbr="layout"]');
        ...
        r && r.addEventListener("click", function() {
            ...
            for (var e = t.target; e;) {
                if (e.hasAttribute("data-layout")) {
                    e = e.getAttribute("data-layout"), n.obj.setLayout(OrgChart[e]);
                    break
                }
                e = e.parentNode
            }
    ...
    var n = this,
        t = {
            id: a.nodeId,
            expandChildren: a.expandChildren
        };
    this._draw(!1, OrgChart.action.exporting, t, function(t) {
        ...
        if (r.innerHTML = t, "svg" == a.ext)
            if (o) o(a, r.innerHTML);
                ...
                if (!1 === i) return !1;
                if (OrgChart._downloadFile(a.mime, e.content, e.options.filename), !1 === (i = OrgChart.events.publish("exportend", [n, e]))) return !1
            } else OrgChart._imgs2base64(r, "image", "xlink:href", function() {
            n._pages(a, r.querySelector("svg"), function(t) {
                ...
                o || OrgChart.loading.show(n), o ? o(n, e, r.querySelector("svg")) : (e = JSON.stringify(e), OrgChart._ajax(n.config.exportUrl + "/v3", "POST", e, "arraybuffer", function(t) {
                    if (!1 === OrgChart.events.publish("exportend", [n, t])) return !1;
                    OrgChart.loading.hide(n), OrgChart._downloadFile(a.mime, t, a.filename)
                }))
            })
        })
    })
    ...
    OrgChart._downloadFile("text/csv;charset=utf-8;", "\ufeff" + i.content, i.filename)
    ...
    if (!1 === OrgChart.events.publish("exportend", [this, i])) return !1;
    OrgChart._downloadFile("application/xml", i.content, i.filename)
    ...
    var t = {
            id: n.nodeId,
            expandChildren: n.expandChildren
        },
        c = [],
        g = [];
    for (var e in this.nodes) {
        0 != (i = this.nodes[e]).childrenIds.length && (i.isAssistant || "split" == i.templateName || g.push(i.id))
    }
        ...
        this.config.roots = [i.id],
            function(r) {
                s._draw(!1, OrgChart.action.exporting, t, function(t) {
                    var a, o, e = document.createElement("div");
                    e.innerHTML = t, a = e, o = r, OrgChart._imgs2base64(a, "image", "xlink:href", function() {
                        for (var t = a.querySelector("svg"), e = s._pagesAfit(n, t), r = 0; r < e.length; r++) {
                            var i = e[r];
                            i.html = a.innerHTML, c.push(i)
                        }
                        g.length - 1 == o && (s.config.collapse = h, s.config.roots = d, l(c))
                    })
                })
            }(r)
    }
    ...
    for (var e in this.nodes) {
        var r = this.nodes[e];
        0 != r.childrenIds.length && (r.isAssistant || "split" == r.templateName || g.push(r.id))
    }
        ...
        this.config.roots = [e],
            function(r) {
                s._draw(!1, OrgChart.action.exporting, t, function(t) {
                    var a, o, e = document.createElement("div");
                    e.innerHTML = t, a = e, o = r, OrgChart._imgs2base64(a, "image", "xlink:href", function() {
                        for (var t = a.querySelector("svg"), e = s._pagesFit(n, t), r = 0; r < e.length; r++) {
                            var i = e[r];
                            i.html = a.innerHTML, c.push(i)
                        }
                        g.length - 1 == o && (s.config.collapse = h, s.config.roots = d, l(c))
    ...
    var n = OrgChart.pdfPrevUI._getViewBox(e),
        l = {
            w: t.landscape ? o - (t.margin[1] + t.margin[3]) : a - (t.margin[1] + t.margin[3]),
            h: t.landscape ? a - (t.margin[0] + t.margin[2]) : o - (t.margin[0] + t.margin[2])
        },
        s = {
            w: t.landscape ? o : a,
            h: t.landscape ? a : o
        ...
        f = n[2],
        u = n[3] / c;
    e.setAttribute("width", l.w), e.setAttribute("height", l.h), e.setAttribute("preserveAspectRatio", "xMidYMin meet");
    ...
    switch (t.format) {
        case "A4":
        case "A42Levels":
            o = OrgChart.A4w, n = OrgChart.A4h;
            break;
        case "A3":
        case "A32Levels":
            o = OrgChart.A3w, n = OrgChart.A3h;
        case "A2":
        case "A22Levels":
            o = OrgChart.A2w, n = OrgChart.A2h;
        case "A1":
        case "A12Levels":
            o = OrgChart.A1w, n = OrgChart.A1h
    }
    var l = a[0],
        s = a[1],
        h = a[2],
        d = a[3],
        c = {
            w: t.landscape ? n - (t.margin[1] + t.margin[3]) : o - (t.margin[1] + t.margin[3]),
            h: t.landscape ? o - (t.margin[0] + t.margin[2]) : n - (t.margin[0] + t.margin[2])
        },
        g = {
            w: t.landscape ? n : o,
            h: t.landscape ? o : n
        };
    e.setAttribute("preserveAspectRatio", "xMinYMin slice"), e.setAttribute("width", c.w), e.style.display = "";
    for (var p = c.w, f = c.h, u = l, C = s, m = []; u < h;) {
        for (; C < d;) {
            var O = [u, C, h, d];
            O = O.join(), m.push({
                vb: O,
    ...
    return {
        on: function(t, e, r) {
            Array.isArray(n[t]) || (n[t] = []), n[t].push({
                listener: e,
                event_id: r
            })
        },
        ...
        removeForEventId: function(t) {
            for (var e in n)
                if (Array.isArray(n[e]))
                    for (var r = n[e].length - 1; 0 <= r; r--) n[e][r].event_id == t && n[e].splice(r, 1)
        },
        publish: function(t, e) {
            if (n[t]) {
                ...
                if (0 < r.length) {
                    var o = !0;
                    for (i = 0; i < r.length; i++) 1 == e.length ? o = r[i](e[0]) && o : 2 == e.length ? o = r[i](e[0], e[1]) && o : 3 == e.length ? o = r[i](e[0], e[1], e[2]) && o : 4 == e.length ? o = r[i](e[0], e[1], e[2], e[3]) && o : 5 == e.length && (o = r[i](e[0], e[1], e[2], e[3], e[4]) && o);
                    return o
                }
            }
        }
    ...
    this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    var e = this.getBGNode(t);
    if (e.collapsedChildrenIds.length) {
        if (!1 === OrgChart.events.publish("expcollclick", [this, OrgChart.EXPAND, t, e.collapsedChildrenIds])) return !1;
        this.expand(t, e.collapsedChildrenIds, !1)
    } else {
        if (!1 === OrgChart.events.publish("expcollclick", [this, OrgChart.COLLAPSE, t, e.childrenIds])) return !1;
    ...
    if (e.groupState == OrgChart.EXPAND) {
        if (!1 === OrgChart.events.publish("expcollclick", [this, OrgChart.COLLAPSE, t])) return !1;
        this.minimize(t)
    } else if (e.groupState == OrgChart.COLLAPSE) {
        if (!1 === OrgChart.events.publish("expcollclick", [this, OrgChart.EXPAND, t])) return !1;
        this.maximize(t)
    }
    ...
    for (var i = e.target; i != t;) {
        if (i.hasAttribute("node-id")) return e.stopPropagation(), e.preventDefault(), void this._nodeMouseDownHandler(i, e, r);
        i = i.parentNode
    }
    ...
    e.preventDefault(), this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    var r = this.get(t),
        i = null;
    ...
    void 0 === d && (d = -e.detail), d = Math.max(-1, Math.min(1, d)), n += -d * a, i || function t() {
        i = !0;
        var e = (n - l) / o;
        0 < e ? e++ : e--, l += e, r.zoom(1 - e / 12 / 50, s), parseInt(l) == parseInt(n) ? i = !1 : h(t)
    }()
    ...
    if (this.config.enableDragDrop) {
        ...
        if (!1 !== OrgChart.events.publish("drag", [this, i])) {
            ...
            var d = this,
                ...
                C = d.getScale(),
                m = t.cloneNode(!0);
            if (c.insertBefore(m, c.firstChild), m.style.opacity = .7, l.isChildOfGroup) {
                var a = this.getNodeElement(l._groupParentNodeId),
                    o = OrgChart._getTransform(a);
                f += o[4], u += o[5], p[4] = f, p[5] = u, m.setAttribute("transform", "matrix(" + p.toString() + ")")
            }
            var O = function(t, e) {
                    if (null != t) {
                        var r = d.getBGNode(t);
                        r.isChildOfGroup && (d.getNodeElement(r._groupParentNodeId).style.opacity = 1), e.style.opacity = 1
                    }
                },
                v = function(t) {
                    ...
                    if (null != s) {
                        var a = d.getBGNode(s);
                        a.isChildOfGroup && (d.getNodeElement(a._groupParentNodeId).style.opacity = .8), h.style.opacity = .5
                    }
                    var o = (e.x - g.x) / C,
                        n = (e.y - g.y) / C;
                    p[4] = f + o, p[5] = u + n, m.setAttribute("transform", "matrix(" + p.toString() + ")")
                },
                x = function(t) {
                    if (c.removeEventListener(n.move, v), c.removeEventListener(n.up, x), n.leave && c.removeEventListener(n.leave, x), l.id == s || l.isChildOfGroup && l._groupParentNodeId == s || null == s) return O(s, h), c.removeChild(m), void(d._gragStartedId = null);
                    var e = d.getBGNode(s);
                    if (e.isChildOfGroup && l.isChildOfGroup && e._groupParentNodeId == l._groupParentNodeId) return O(s, h), c.removeChild(m), void(d._gragStartedId = null);
                    if (!1 === OrgChart.events.publish("drop", [d, l.id, e.id])) return O(s, h), c.removeChild(m), void(d._gragStartedId = null);
                    if (null == d.config.dragDropMenu || l.isGroup && !e.isGroup) d._canUpdateLink(l.id, s) ? d.linkNode(l.id, s) : c.removeChild(m);
                        ...
                        if (Array.isArray(l.tags))
                            for (var a = 0; a < l.tags.length; a++) {
                                var o = l.tags[a];
                                d.config.tags[o] && d.config.tags[o].dragDropMenu && (i = d.config.tags[o].dragDropMenu)
                            }
                        d.dragDropMenuUI.show(r.x, r.y, l.id, s, i)
                    } else c.removeChild(m);
                    d._gragStartedId = null
                };
            c.addEventListener(n.move, v), c.addEventListener(n.up, x), n.leave && c.addEventListener(n.leave, x)
        }
    }
    ...
    this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    var i = this.getBGNode(t);
    if (r == OrgChart.action.expandCollapse) {
        if (i.collapsedChildrenIds.length) {
            if (!1 === OrgChart.events.publish("expcollclick", [this, OrgChart.EXPAND, t, i.collapsedChildrenIds])) return !1;
            this.expand(t, i.collapsedChildrenIds, !1)
        } else {
            if (!1 === OrgChart.events.publish("expcollclick", [this, OrgChart.COLLAPSE, t, i.childrenIds])) return !1;
    ...
    if (Array.isArray(i.tags))
        for (var o = 0; o < i.tags.length; o++) {
            var n = i.tags[o];
            this.config.tags[n] && this.config.tags[n].nodeMenu && (a = this.config.tags[n].nodeMenu)
        }
    this.nodeMenuUI.showStickIn(e, t, null, a)
}, OrgChart.prototype._exportMenuClickHandler = function(t, e) {
    e.stopPropagation(), e.preventDefault(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.show(t.offsetLeft, t.offsetTop)
}, OrgChart.prototype._lonelyButtonHandler = function() {
    var t = new OrgChart.node(OrgChart._randomId(), null, [], this.config.template);
    ...
    this.templateName = i, this.id = t, this.pid = e, this.x = null, this.y = null, this.level = null, this.leftNeighbor = null, this.rightNeighbor = null, this._prelim = 0, this._modifier = 0, this.children = [], this.parent = null, this.isAssistant = !1, this.tags = r, this.collapsedChildrenIds = [], this.childrenIds = [];
    var a = OrgChart.t(this.templateName);
    this.w = a && a.size ? a.size[0] : 0, this.h = a && a.size ? a.size[1] : 0, this.groupState = OrgChart.EXPAND, this.isChildOfGroup = !1, this.isGroup = !1, this._groupParentNodeId = null, this._groupSettings = null, this.bgnodes = []
}, OrgChart.prototype._mouseDownHandler = function(t, e, r) {
    var s = this;
    document.body.style.mozUserSelect = document.body.style.webkitUserSelect = document.body.style.userSelect = "none", this.editUI.hide(), this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.dragDropMenuUI.hide(), this.menuUI.hide();
    ...
    if ("pan" == c.type) {
        ...
        var n = OrgChart._getOffsetXY(this.element, e),
            l = n.x / d + h[0] - 16 / d,
            g = n.y / d + h[1] - 16 / d;
        o.style.display = "inherit", o.setAttribute("transform", "matrix(0,0,0,0," + l + "," + g + ")"), OrgChart.anim(o, {
            transform: [0, 0, 0, 0, l, g],
            opacity: 0
        }, {
            transform: [1 / d, 0, 0, 1 / d, l, g],
            opacity: 1
    ...
    var p = function(t) {
            ...
            if (c && "pan" == c.type) {
                ...
                var a = OrgChart._getClientTouchesXY(t, 1),
                    o = Math.sqrt((e.x - a.x) * (e.x - a.x) + (e.y - a.y) * (e.y - a.y)),
        ...
        f = function() {
            ...
            }) : "pan" != c.type || s.config.sticky || s._draw(!0, OrgChart.action.pan), c = null, o.style.display = "none", t.removeEventListener(r.move, p), t.removeEventListener(r.up, f), r.leave && t.removeEventListener(r.leave, f), r.touchstart && t.removeEventListener(r.touchstart, f)
        };
...
}, void 0 === OrgChart && (OrgChart = {}), void 0 === OrgChart.remote && (OrgChart.remote = {}), OrgChart.LIMIT_NODES = !0, OrgChart.remote._fromResDTO = function(t, e, r, i) {
    var a = e[t.id];
    ...
    for (var l = 0; l < t.children.length; l++) OrgChart.remote._fromResDTO(t.children[l], e, r, i)
    ...
    var i = {
        p: [t.id, null != t.parent ? t.parent.id : null, t.w, t.h]
    };
    0 < t.children.length && (i.c = OrgChart.remote._convertToIdArray(t.children)), null != t.layout && 0 != t.layout && (i.l = t.layout), t.isAssistant && (i.a = 1), t.templateName != r && (i.t = t.templateName), e.push(i);
    for (var a = 0; a < t.children.length; a++) OrgChart.remote._toReqDTO(t.children[a], e, r)
}, OrgChart.remote._convertToIdArray = function(t) {
    for (var e = [], r = 0; r < t.length; r++) e.push(t[r].id);
    return e
}, OrgChart.remote._walk = function(r, t, i) {
    for (var e = [], a = [], o = [t.orientation, t.levelSeparation, t.mixedHierarchyNodesSeparation, t.subtreeSeparation, t.siblingSeparation, t.template], n = 0; n < r.length; n++) a.push(r[n].id), OrgChart.remote._toReqDTO(r[n], e, t.template);
    var l = {
        n: e,
        c: o,
        r: a,
    ...
    OrgChart.LIMIT_NODES || (l.l = !0), null != OrgChart.remote._fromReqDTO ? OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function(t) {
        for (var e = 0; e < r.length; e++) OrgChart.remote._fromResDTO(r[e], t, 0, r);
        i()
    }) : (l = JSON.stringify(l), OrgChart.idb.read(l, function(t, e) {
        t ? OrgChart.remote._proceed(r, e.res, i) : OrgChart.remote._findRegion(function(t) {
            OrgChart._ajax(t, "post", l, "json", function(t) {
                t.error ? i(2) : (OrgChart.remote._proceed(r, t, i), OrgChart.idb.write({
                    id: l,
                    res: t
                }))
            })
    ...
    if ("string" == typeof e && (e = JSON.parse(e)), e.limit && 1 == e.limit) r(e.limit);
    else {
        for (var i = 0; i < t.length; i++) OrgChart.remote._fromResDTO(t[i], e, 0, t);
        r()
    }
    ...
    if (t) r(t);
        ...
        for (var i = ["au-e", "au-se", "brs", "ca", "ca-e", "easia", "eus-2", "eus", "fr", "ind", "jp-e", "jp-w", "kr", "n-eu", "se-asia", "s-ind", "uk-s", "uk-w", "us", "us-n-c", "us-s-c", "w-c-us", "w-eu", "w-ind", "w-us-2", "wus"], a = [], o = 0; o < i.length; o++) a.push(new XMLHttpRequest);
        for (o = 0; o < i.length; o++) ! function() {
            var e = "https://" + i[o] + "-balkangraph.azurewebsites.net/api/OrgChartJS",
                t = a[o];
    ...
    if (t) {
        ...
        r.value = "", i.innerHTML = "", "none" != e.style.display && "none" != t.style.display && OrgChart.anim(e, {
            opacity: e.style.opacity
        }, {
            opacity: 0
        }, 200, OrgChart.anim.inOutSin, function() {
            e.style.display = "none", OrgChart.anim(t, {
                width: 300,
                opacity: 1
            }, {
                width: 50,
    ...
    r.style.display = "none", e.style.width = "50px", e.style.display = "block", e.style.opacity = 0, OrgChart.anim(e, {
        ...
        r.style.display = "inherit", r.style.opacity = 0, OrgChart.anim(r, {
            opacity: 0
        }, {
            opacity: 1
        }, 200, OrgChart.anim.inOutSin), t && t()
    })
    ...
    e.addEventListener("mouseover", function() {
        ...
        40 == t.keyCode ? o() : 38 == t.keyCode ? n() : 13 == t.keyCode ? l() : 27 == t.keyCode ? r.hide() : r._serverSearch(this.value)
    });
    var o = function() {
        ...
        l = function() {
            var t = i.querySelector('[data-selected="yes"]').getAttribute("data-search-item-id"),
    ...
    for (var e = this, r = this.obj.element.querySelector('[data-id="container"]'), i = this.obj.element.querySelector('[data-id="search"]'), a = this.obj.server.find(t), o = "", n = 0; n < a.length; n++) {
        var l = a[n],
            s = "";
        l.img && (s = '<img style="padding: 2px 0px  2px 7px;width:32px;height:32px;" src="' + l.img + '" / >'), o += OrgChart.searchUI.createItem(s, l)
    }
    r.innerHTML = o;
    var h = i.querySelectorAll("[data-search-item-id]");
    for (n = 0; n < h.length; n++) h[n].addEventListener("click", function() {
    ...
    return '<div data-search-item-id="' + e.id + '" style="border-top:1px solid #d7d7d7; padding: 7px 0 7px 0;cursor:pointer;"><div style="float:left;">' + t + '</div><div style="float:right; width:83%"><div style="overflow:hidden; white-space: nowrap;text-overflow:ellipsis;text-align:left;">' + e.textId + '</div><div style="overflow:hidden; white-space: nowrap;text-overflow:ellipsis;text-align:left;">' + e.textInNode + '</div></div><div style="clear:both;"></div></div>'
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.server = function(t) {
    this.config = t, this.visibleNodes = null, this.viewBox = null, this.action = null, this.actionParams = null, this.groupChildren = {}, this.nodes = {}, this.oldNodes = {}, this.maxX = null, this.maxY = null, this.minX = null, this.minY = null, this.root = null
    ...
    if (t) {
        var C = OrgChart.server._getResponse(r, i, this.visibleNodes, this.config, h, d, c, g, this.viewBox, p, this.action, this.actionParams, f, u, this.oldNodes);
        a != OrgChart.action.exporting && (this.maxX = h, this.maxY = d, this.minX = c, this.minY = g, this.root = p, this.nodes = f, this.groupChildren = u, this.visibleNodes = C.visibleNodes), n(C)
    } else this.oldNodes = f || null, this._read(function(t) {
        h = t.maxX, d = t.maxY, c = t.minX, g = t.minY, p = t.roots[0], f = t.nodes, u = t.groupChildren;
        var e = OrgChart.server._getResponse(r, i, s.visibleNodes, s.config, h, d, c, g, s.viewBox, p, s.action, s.actionParams, f, u, s.oldNodes);
        e.notif = t.limit, a != OrgChart.action.exporting && (s.maxX = h, s.maxY = d, s.minX = c, s.minY = g, s.root = p, s.nodes = f, s.groupChildren = u, s.visibleNodes = e.visibleNodes), n(e)
    }, l)
}, OrgChart.server.prototype._read = function(a, t) {
    var o = this,
        n = OrgChart.server._createNodes(this.config, this.action, this.actionParams, this.oldNodes);
    t(n);
    var l = n.nodes,
        s = n.roots,
        e = OrgChart.remote;
    null == e && (e = OrgChart.local), e._walk(s, this.config, function(t) {
        OrgChart.server._doNotChangePositionOfClickedNodeIfAny(s, l, o.action, o.actionParams, o.oldNodes, o.config.orientation);
        var e = {
            minX: null,
            minY: null,
            maxX: null,
    ...
    for (var e, i, a, o = function(t) {
            for (var e in r.config.nodeBinding)
                if (r.config.nodeBinding[e] == t) return !0;
            return !1
        }, n = [], l = [], s = 0; s < this.config.nodes.length; s++) {
        var h = this.config.nodes[s];
        for (var d in h) {
            var c = h[d];
            0 < this.config.searchFields.length && -1 == this.config.searchFields.indexOf(d) || c && -1 != OrgChart.accentFold(c).indexOf(t) && !OrgChart._fieldIsImg(this.config, d) && n.push({
                id: h.id,
                propertyName: d,
                isId: d == OrgChart.ID,
                isNodeParam: o(d),
    ...
    for (s = 0; s < n.length && 10 != s; s++) {
        ...
        if (!g) {
            ...
            for (p = 0; p < O.length; p++) {
                d = O[p], c = n[s].data[d];
                d === n[s].propertyName && (e = c, i = t, void 0, a = OrgChart.accentFold(e).indexOf(i), c = e.toString().splice(a + i.length, 0, "</mark>").splice(a, 0, "<mark>")), d != OrgChart.TAGS && (d == OrgChart.ID ? u = u + c + ", " : OrgChart._fieldIsImg(this.config, d) ? m = c : o(d) && !OrgChart._fieldIsImg(this.config, d) ? f = f + c + ", " : OrgChart._fieldIsImg(this.config, d) || (C = C + c + ", "))
            }
            u = u.slice(0, u.length - 2), f = f.slice(0, f.length - 2), C = C.slice(0, C.length - 2);
            var v = OrgChart._getTemplate(n[s].tags, this.config.tags, this.config.template);
            l.push({
                id: n[s].id,
    ...
    return l
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.server._createNodes = function(t, e, r, i) {
    for (var a = t.nodes, o = {}, n = [], l = [], s = [], h = {}, d = !1, c = 0; c < a.length; c++) {
        var g = a[c],
            p = Array.isArray(g.tags) ? g.tags.slice(0) : [],
            f = OrgChart._getGroup(p, t.tags),
            u = OrgChart._getTemplate(p, t.tags, t.template);
        if ((v = new OrgChart.node(g.id, g.pid, p, u)).isAssistant = -1 != p.indexOf("assistant"), v.isAssistant && -1 == s.indexOf(v.pid) && s.push(v.pid), null != f) {
            if (!o[f.name]) {
                n.push(f.name);
                var C = new OrgChart.node(f.name, g.pid, [f.name], f.tag.template);
                C.isGroup = !0, null != t.orderBy && (C.order = g[t.orderBy]), o[f.name] = C
            }
            v.isChildOfGroup = !0, v._groupParentNodeId = f.name, o[f.name].bgnodes.push(v), 1 == v.isAssistant && (o[f.name].isAssistant = !0), h[v.id] = f.name, d = !0
        } else null != t.orderBy && (v.order = g[t.orderBy]), o[g.id] = v, n.push(g.id)
    }
    if (null != t.orderBy && n.sort(function(t, e) {
            var r = o[t].order,
                i = o[e].order;
            return "number" == typeof r || "number" == typeof i ? (null == r && (r = -1), null == i && (i = -1), r - i) : "string" == typeof r || "string" == typeof i ? (null == r && (r = ""), null == i && (i = ""), r.localeCompare(i)) : void 0
        }), d)
    ...
    for (c = 0; c < n.length; c++) {
        var O = n[c],
            v = o[O],
            x = i ? i[O] : null;
        if (null != v.pid && null != v.pid && "" !== v.pid)(w = o[v.pid]) ? ((v.parent = w).children.push(v), w.childrenIds.push(v.id)) : (v.pid = null, v.parent = null, l.push(v));
        else l.push(v);
        e == OrgChart.action.exporting && null != r.id && (l = [o[r.id]]), x ? (v.state = x.state, v.state == OrgChart.COLLAPSE && m.push(v.id), OrgChart.server._setNodeGroupState(v, x.groupState, t.orientation)) : OrgChart.server._setNodeGroupState(v, OrgChart.EXPAND, t.orientation), OrgChart.server._initStates(v, o, e, t, r, m), OrgChart.server._initGroupStates(v, o, e, t, r)
    }
    if (null != t.roots) {
        l = [];
        for (c = 0; c < t.roots.length; c++) {
            ...
            if (y) {
                if (y.parent)
                    for (var b = (w = y.parent).children.length - 1; 0 <= b; b--) {
                        (z = w.children[b]) == y && (z.parent = null, w.children.splice(b, 1), w.childrenIds.splice(b, 1))
                    }
                l.push(y)
            }
        }
    ...
    for (c = 0; c < s.length; c++) {
        var w = o[s[c]],
            _ = new OrgChart.node(w.id + "_split_0", w.id, [], "split");
        (o[_.id] = _).isAssistant = !0, (x = i[_.id]) && (o[_.id].state = x.state, o[_.id].state == OrgChart.COLLAPSE && m.push(_.id)), OrgChart.server._initStates(_, o, e, t, r, m);
        var k = [];
        for (b = w.children.length - 1; 0 <= b; b--) {
            (z = w.children[b]).isAssistant ? (z.parent = null, w.children.splice(b, 1), w.childrenIds.splice(b, 1), k.splice(0, 0, z.id)) : (z.pid = _.id, (z.parent = _).children.push(z), _.childrenIds.push(z.id), w.children.splice(b, 1))
        }
        if (k.length % 2) {
            ...
            OrgChart.templates[I] = {
                ...
                nodeMenuButton: "",
                size: S
            }, (V = new OrgChart.node(w.id + "_transperant", A.pid, [], I)).isAssistant = !0, o[V.id] = V, k.splice(k.length - 1, 0, V.id)
        }
        var N = 1;
        for (b = k.length - 1; 0 <= b; b--) {
            if (b % 2 && b != k.length - 1)(W = new OrgChart.node(w.id + "_split_" + N, null, [], "split")).isAssistant = !0, o[W.id] = W, k.splice(b, 0, W.id), N++;
        ...
        for (b = 0; b < k.length; b += 3) {
            ...
            var E = o[k[b]],
                L = o[k[b + 1]],
                B = o[k[b + 2]];
            E.parent = M, E.pid = M.id, L.parent = M, L.pid = M.id, B.parent = M, B.pid = M.id, M.children.push(E), M.children.push(L), M.children.push(B), M.childrenIds.push(E.id), M.childrenIds.push(L.id), M.childrenIds.push(B.id);
            for (var T = M;
                "split" == T.templateName && (T = T.parent);) T.childrenIds.push(E.id), T.childrenIds.push(L.id), T.childrenIds.push(B.id)
        }
    }
    if (e == OrgChart.action.centerNode) {
        var P = o[r.id];
        P || (P = o[h[r.id]], OrgChart.server._setNodeGroupState(P, OrgChart.EXPAND, t.orientation)), P.state = OrgChart.EXPAND, -1 != (j = m.indexOf(P.id)) && m.splice(j, 1);
        w = OrgChart.server._getRealParent(P);
        for (var H = P.id; null != w;) {
            if (-1 != (j = m.indexOf(w.id)) && m.splice(j, 1), w.state = OrgChart.EXPAND, r.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS)
                for (c = 0; c < w.childrenIds.length; c++) {
                    var z = o[w.childrenIds[c]];
                    if (!OrgChart.server._isSplit(z) && !z.isAssistant && z.id != H) - 1 == (j = m.indexOf(w.childrenIds[c])) && m.push(w.childrenIds[c]), z.state = OrgChart.COLLAPSE
                }
            if (w.state == OrgChart.EXPAND)
                for (var U = 0; U < w.childrenIds.length; U++) {
                    var F = o[w.childrenIds[U]];
                    if (OrgChart.server._isSplit(F) || F.isAssistant) - 1 != (j = m.indexOf(F.id)) && m.splice(j, 1), F.state = OrgChart.EXPAND
                }
            H = w.id, w = OrgChart.server._getRealParent(w)
        }
        if (r.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < P.childrenIds.length; c++) {
                if (-1 != (j = m.indexOf(P.childrenIds[c])) && m.splice(j, 1), (z = o[P.childrenIds[c]]).state = OrgChart.EXPAND, !z.isAssistant && !OrgChart.server._isSplit(z))
                    for (b = 0; b < z.childrenIds.length; b++) {
                        var j, D = o[z.childrenIds[b]]; - 1 == (j = m.indexOf(z.childrenIds[b])) && m.push(z.childrenIds[b]), D.state = OrgChart.COLLAPSE
                    }
            }
    }
    e == OrgChart.action.exporting && 1 == r.expandChildren && v && (m = []);
    for (c = 0; c < m.length; c++) {
        if (w = (v = o[m[c]]).parent)
            for (b = w.children.length - 1; 0 <= b; b--) {
                if (w.children[b] == v)
                    if (-1 == w.collapsedChildrenIds.indexOf(v.id) && w.collapsedChildrenIds.push(v.id), w.children.splice(b, 1), "split" == v.templateName || "split" == w.templateName) {
                        if (M = v.parent) {
                            for (;
                                "split" == M.templateName;) M = M.parent;
                            for (var G = 0; G < M.childrenIds.length; G++) {
                                var X = M.childrenIds[G]; - 1 == M.collapsedChildrenIds.indexOf(X) && M.collapsedChildrenIds.push(X)
                            }
                        }
                    } else v.parent = null
            }
    ...
    if (t.layout == OrgChart.mixed)
        for (c = 0; c < n.length; c++) {
            if (0 == (v = o[n[c]]).childrenIds.length && !v.isAssistant && "split" != v.templateName)
                if (w = v.parent) {
                    if (!OrgChart.server._mixedLayoutAllNodes(w)) continue;
                    for (b = w.children.length - 1; 0 <= b; b--) {
                        if ((z = w.children[b]) != v && 0 == z.childrenIds.length && !z.isAssistant && "split" != z.templateName) {
                            z.parent = v, z.pid = v.id, z.layout = OrgChart.mixed, w.children.splice(b, 1);
                            var R = v.children.length;
                            v.children[R] = z, v.layout = OrgChart.mixed
                        }
                    }
                }
        }
    if (t.layout == OrgChart.tree || t.layout == OrgChart.treeRightOffset || t.layout == OrgChart.treeLeftOffset) {
        var Y = [];
        for (c = 0; c < n.length; c++) {
            if (0 == (v = o[n[c]]).childrenIds.length && !v.isAssistant && "split" != v.templateName)(w = v.parent) && -1 == Y.indexOf(w.id) && Y.push(w.id)
        }
        for (c = 0; c < Y.length; c++) {
            w = o[Y[c]], _ = new OrgChart.node(w.id + "_split_0", w.id, [], "split");
            (o[_.id] = _).layout = OrgChart.tree;
            var q = [];
            for (b = w.children.length - 1; 0 <= b; b--) {
                if (OrgChart.server._mixedLayoutAllNodes(w))
                    if (0 == (z = w.children[b]).childrenIds.length && !z.isAssistant && "split" != z.templateName && (z.parent && "split" != z.parent.templateName || z.parent.isAssistant)) {
                        if ((z = w.children[b]).parent = null, z.layout = OrgChart.tree, w.children.splice(b, 1), w.childrenIds.splice(b, 1), t.layout == OrgChart.treeRightOffset && q.splice(0, 0, z.id), t.layout == OrgChart.treeLeftOffset || t.layout == OrgChart.treeRightOffset) {
                            var V;
                            ...
                            OrgChart.templates[I] = {
                                ...
                                nodeMenuButton: "",
                                size: [0, 0]
                            }, (V = new OrgChart.node(z.id + "_transperant", null, [], I)).layout = OrgChart.tree, o[V.id] = V, q.splice(0, 0, V.id)
                        }
                        t.layout != OrgChart.treeRightOffset && q.splice(0, 0, z.id)
                    }
            }
            for (N = 1, b = q.length - 1; 0 <= b; b--) {
                var W;
                if (b % 2 && b != q.length - 1)(W = new OrgChart.node(w.id + "_split_" + N, null, [], "split")).layout = OrgChart.tree, o[W.id] = W, q.splice(b, 0, W.id), N++;
                else b % 2 && q.splice(b, 0, _.id)
            }
            for (b = 0; b < q.length; b += 3) {
                M = null;
                0 == b && (M = w);
                E = o[q[b]], L = o[q[b + 1]], B = o[q[b + 2]];
                0 != b && (M = o[q[b - 3]]), 0 == b || L || (M = o[q[b - 2]]), E.parent = M, E.pid = M.id, M.children.push(E), w.childrenIds.push(E.id), L && (0 != b && (M = o[q[b - 2]]), L.parent = M, L.pid = M.id, M.children.push(L), w.childrenIds.push(L.id)), B && (0 != b && (M = o[q[b - 1]]), B.parent = M, B.pid = M.id, M.children.push(B), w.childrenIds.push(B.id))
            }
        }
    }
    return {
    ...
    for (var e = t.children.length - 1; 0 <= e; e--) {
        var r = t.children[e];
        if (0 < r.childrenIds.length || r.isAssistant || "split" == r.templateName) return !1
    }
    return !0
    ...
    if (r == OrgChart.action.init && t) {
        if (t.tags)
            for (var n = 0; n < t.tags.length; n++) {
                var l = t.tags[n];
                i.tags && i.tags[l] && null != i.tags[l].state && (i.tags[l].state == OrgChart.COLLAPSE && o.push(t.id), t.state = i.tags[l].state)
            }
        OrgChart.server._expandCollapseToLevel(t, e, r, i, a, o)
    } else if (r == OrgChart.action.expandCollapse && "expandCollapseToLevel" == a.method) {
        -1 != (s = o.indexOf(t.id)) && o.splice(s, 1), t.state = OrgChart.EXPAND, OrgChart.server._expandCollapseToLevel(t, e, r, i, a, o)
    } else if (r != OrgChart.action.expandCollapse || -1 == a.ids.indexOf(t.id) && "all" != a.ids) {
        if (r == OrgChart.action.exporting) {
            -1 != (s = o.indexOf(t.id)) && o.splice(s, 1), t.state = OrgChart.EXPAND, OrgChart.server._expandCollapseToLevel(t, e, r, i, a, o)
        }
    } else {
        if (a.state == OrgChart.COLLAPSE) o.push(t.id);
        else if (a.state == OrgChart.EXPAND) {
            var s; - 1 != (s = o.indexOf(t.id)) && o.splice(s, 1)
        }
        t.state = a.state
    }
    ...
    if (i.collapse.level) {
        ...
        if (n >= i.collapse.level) {
            ...
            if (Array.isArray(i.expand.nodes))
                ...
                !s && i.collapse.allChildren ? (o.push(t.id), t.state = OrgChart.COLLAPSE) : s || i.collapse.allChildren || n != i.collapse.level || (o.push(t.id), t.state = OrgChart.COLLAPSE)
        }
    }
}, OrgChart.server._initGroupStates = function(t, e, r, i, a) {
    if (r == OrgChart.action.exporting && 1 == a.expandChildren && t) OrgChart.server._setNodeGroupState(t, OrgChart.EXPAND, i.orientation);
    else {
        if (r == OrgChart.action.init && t && t.isGroup) {
            var o = i.tags[t.id].groupState;
            OrgChart.server._setNodeGroupState(t, o, i.orientation)
        }
        r == OrgChart.action.groupMaxMin && OrgChart.server._setNodeGroupState(e[a.id], a.state, i.orientation)
    }
    ...
    if (t.isGroup && t.groupState == OrgChart.EXPAND) {
        var n = t.bgnodes.length,
            ...
            h = o = a = 0,
            d = 0;
        if (0 == i.layout_type) switch (r) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.bottom_left:
                l = 1, s = n;
                for (var c = 0; c < t.bgnodes.length; c++) h = Math.max(t.bgnodes[c].w, h), d = Math.max(t.bgnodes[c].h, d), o += t.bgnodes[c].h + i.groupNodesSeparation;
                o -= i.groupNodesSeparation, a = h;
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.left:
            case OrgChart.orientation.right_top:
            case OrgChart.orientation.left_top:
                l = n, s = 1;
                for (c = 0; c < t.bgnodes.length; c++) h = Math.max(t.bgnodes[c].w, h), d = Math.max(t.bgnodes[c].h, d), a += t.bgnodes[c].w + i.groupNodesSeparation;
                a -= i.groupNodesSeparation, o = d
        } else switch (r) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.bottom_left:
                ...
                for (c = 0; c < t.bgnodes.length; c++) h = Math.max(t.bgnodes[c].w, h), d = Math.max(t.bgnodes[c].h, d);
                a = h * l + i.groupNodesSeparation * l + i.groupNodesSeparation + i.groupPadding[1] + i.groupPadding[3], o = d * s + i.groupNodesSeparation * s + i.groupNodesSeparation + i.groupPadding[0] + i.groupPadding[2];
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.left:
            case OrgChart.orientation.right_top:
    ...
    for (r = 0; r < t.nodes.length; r++)
        for (var i in t.nodes[r]) i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && (t.nodeBinding[i] || OrgChart._arrayContains(e, i) || e.push(i));
    return e
}, OrgChart.server._doNotChangePositionOfClickedNodeIfAny = function(t, e, r, i, a, o) {
    if (r == OrgChart.action.expandCollapse || r == OrgChart.action.groupMaxMin || r == OrgChart.action.centerNode || r == OrgChart.action.update || r == OrgChart.action.insert) {
    ...
    if (t.isGroup && t.groupState == OrgChart.EXPAND) {
        var r = OrgChart.t(t.templateName),
            i = 0,
            a = 0;
        if (0 == r.layout_type) switch (e) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.bottom_left:
                for (var o = 0, n = 0; n < t.bgnodes.length; n++) {
                    (s = t.bgnodes[n]).x = t._groupSettings._cellWidth / 2 - s.w / 2, s.y = t._groupSettings._cellHeight / 2 - s.h / 2 + o, o += s.h + r.groupNodesSeparation
                }
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.left:
            ...
            case OrgChart.orientation.left_top:
                var l = 0;
                for (n = 0; n < t.bgnodes.length; n++) {
                    (s = t.bgnodes[n]).y = t._groupSettings._cellHeight / 2 - s.h / 2, s.x = t._groupSettings._cellWidth / 2 - s.w / 2 + l, l += s.w + r.groupNodesSeparation
                }
        } else
            for (n = 0; n < t.bgnodes.length; n++) {
                var s;
                (s = t.bgnodes[n]).x = t._groupSettings._cellWidth / 2 - s.w / 2 + r.groupNodesSeparation + (t._groupSettings._cellWidth * i + r.groupNodesSeparation * i), s.y = t._groupSettings._cellHeight / 2 - s.h / 2 + r.groupNodesSeparation + (t._groupSettings._cellHeight * a + r.groupNodesSeparation * a), i >= t._groupSettings._columns - 1 ? (i = 0, a++) : i++
            }
    }
}, OrgChart.server._getResponse = function(t, e, r, i, a, o, n, l, s, h, d, c, g, p, f) {
    var u = {},
        C = {
            top: null,
            left: null,
        ...
        O = a - n + 2 * i.padding,
        v = o - l + 2 * i.padding,
        x = OrgChart.getScale(s, t, e, i.scaleInitial, O, v);
    if (C.top = l - i.padding, C.left = n - i.padding, C.bottom = o + i.padding - e / x, C.right = a + i.padding - t / x, C.maxX = a, C.minX = n, C.maxY = o, C.minY = l, null == s && i.align == OrgChart.CENTER) {
        var y = Math.ceil(t / x),
            b = Math.ceil(e / x),
            w = 0,
            _ = 0;
        if (y - 2 * i.padding >= a - n) switch (w = (a + n) / 2 - y / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                w = (n - a) / 2 - y / 2
        } else switch (w = h.x - y / 2 + OrgChart.server._getNodeWidth(h, i) / 2, i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                (w = -(y / 2 - (n - a) / 2)) < i.padding - y && (w = i.padding - y);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.bottom_left:
            case OrgChart.orientation.top_left:
            case OrgChart.orientation.left_top:
                (w = -(y / 2 - (a - n) / 2)) > -i.padding && (w = -i.padding)
        }
        if (b - 2 * i.padding >= o - l) switch (_ = (o + l) / 2 - b / 2, i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                _ = (l - o) / 2 - b / 2
        } else switch ((_ = -(b / 2 - (o - l) / 2)) > -i.padding && (_ = -i.padding), i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
        ...
        y = Math.ceil(t / x), b = Math.ceil(e / x), w = 0, _ = 0;
        switch (i.orientation) {
            case OrgChart.orientation.top:
                w = h.x - y / 2 + OrgChart.server._getNodeWidth(h, i) / 2, _ = -i.padding;
                break;
            case OrgChart.orientation.bottom:
                w = h.x - y / 2 + OrgChart.server._getNodeWidth(h, i) / 2, _ = i.padding - b;
                break;
            case OrgChart.orientation.left:
                w = -i.padding, _ = h.y - b / 2 + OrgChart.server._getNodeWidth(h, i) / 2;
                break;
            case OrgChart.orientation.right:
                w = i.padding - y, _ = h.y - b / 2 + OrgChart.server._getNodeWidth(h, i) / 2;
                break;
            case OrgChart.orientation.top_left:
                w = -i.padding, _ = -i.padding;
                break;
            case OrgChart.orientation.right_top:
                w = i.padding - y, _ = -i.padding;
                break;
            case OrgChart.orientation.left_top:
                w = -i.padding, _ = -i.padding;
                break;
    ...
    d == OrgChart.action.centerNode && ((B = g[c.id]) || (B = g[p[c.id]]), 1 == c.options.horizontal && (s[0] = B.x + B.w / 2 - s[2] / 2), 1 == c.options.vertical && (s[1] = B.y + B.h / 2 - s[3] / 2), i.sticky && (s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left), s[0] > C.right && s[0] > C.left && (s[0] = C.left > C.right ? C.left : C.right), s[1] < C.top && s[1] < C.bottom && (s[1] = C.top > C.bottom ? C.bottom : C.top), s[1] > C.bottom && s[1] > C.top && (s[1] = C.top > C.bottom ? C.top : C.bottom)));
    if (d == OrgChart.action.insert || d == OrgChart.action.expandCollapse || d == OrgChart.action.update || d == OrgChart.action.centerNode) {
        var k = null;
        if (d == OrgChart.action.insert && c && null != c.insertedNodeId && null != c.insertedNodeId)(k = g[c.insertedNodeId]) || (k = g[p[c.insertedNodeId]]);
        else if (d == OrgChart.action.update && c && null != c.visId && null != c.visId)(k = g[c.visId]) || (k = g[p[c.visId]]);
        else if (d == OrgChart.action.expandCollapse && c && null != c.id && null != c.id)(k = g[c.id]) || (k = g[p[c.id]]), k = OrgChart.server._getMostDeepChild(k, g);
            ...
            k && (k || (k = g[p[c.id]]), k = OrgChart.server._getMostDeepChild(k, g))
        }
        if (k) switch (i.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
    ...
    for (var S in g) {
        ...
        if (OrgChart.server._isVisible(I, i, s, d)) {
            u[I.id] = I;
            var N = null;
            if (d == OrgChart.action.expandCollapse && f && f[I.id] && "expandCollapseToLevel" == c.method) {
                if (N = {
                        x: (T = f[I.id]).x,
                        y: T.y
                    }, T) {
                    ...
                    for (var M = I, E = null; null != M;) f[M.id] && f[M.id].state == OrgChart.COLLAPSE && (E = M), M = M.parent;
                    E && E.parent && (N = {
                        x: E.parent.x,
                        y: E.parent.y
                    })
                ...
                if (N = {
                    ...
                    for (M = I, E = null; null != M;) f[M.id] && f[M.id].state == OrgChart.COLLAPSE && (E = M), M = M.parent;
                    E && E.parent && (N = {
                        x: E.parent.x,
                        y: E.parent.y
                    })
                ...
                if (L = g[c.id]) {
                    for (M = I.parent; null != M && -1 == c.ids.indexOf(I.id) && -1 == c.ids.indexOf(M.id);) M = M.parent;
                    M && (N = {
                        x: L.x + L.w / 2 - I.w / 2,
                        y: L.y + L.h / 2 - I.h / 2
                    })
                ...
                var B;
                if (null != (T = f[I.id]).x && null != T.y && (N = {
                        x: T.x,
                        y: T.y
                    }), (B = g[c.id]) && B == I)(M = I.parent) && M.id == c.id && (N = {
                    x: B.x + B.w / 2 - I.w / 2,
                    y: B.y + B.h / 2 - I.h / 2
                })
            ...
            } else if (d == OrgChart.action.insert && c && c.insertedNodeId == I.id) N = {
                x: I.parent.x,
                y: I.parent.y
            };
            else if ((d == OrgChart.action.update || d == OrgChart.action.insert) && f && f[I.id]) {
                var T;
                N = {
                    x: (T = f[I.id]).x,
                    y: T.y
                }
            } else d !== OrgChart.action.exporting && r && !r[I.id] && (m[0].push(I.id), m[1].push({
                opacity: 0
            }), m[2].push({
                opacity: 1
            }));
            null != N && null != N.x && null != N.y && (N.x == I.x && N.y == I.y || (m[0].push(I.id), m[1].push({
    ...
    assistanseLink: '<path stroke-linejoin="round" stroke="#aeaeae" stroke-width="2px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} {xd},{yd} L{xe},{ye}"/>',
    pointer: '<g data-pointer="pointer" transform="matrix(0,0,0,0,100,100)"><radialGradient id="pointerGradient"><stop stop-color="#ffffff" offset="0" /><stop stop-color="#C1C1C1" offset="1" /></radialGradient><circle cx="16" cy="16" r="16" stroke-width="1" stroke="#acacac" fill="url(#pointerGradient)"></circle></g>',
    node: '<rect x="0" y="0" height="120" width="250" fill="#E68E58" stroke-width="1" stroke="#aeaeae" rx="5" ry="5"></rect>',
    plus: '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#aeaeae"></line>',
    minus: '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#aeaeae" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#aeaeae"></line>',
    nodeMenuButton: '<g style="cursor:pointer;" transform="matrix(1,0,0,1,225,105)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>',
    exportMenuButton: '<div style="position:absolute;right:{p}px;top:{p}px; width:40px;height:50px;cursor:pointer;" control-export-menu=""><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"><hr style="background-color: #7A7A7A; height: 3px; border: none;"></div>',
...
}, OrgChart.templates.deborah = Object.assign({}, OrgChart.templates.polina), OrgChart.templates.deborah.size = [150, 150], OrgChart.templates.deborah.node = '<rect x="0" y="0" height="150" width="150" fill="#E68E58" stroke-width="1" stroke="#686868" rx="15" ry="15"></rect>', OrgChart.templates.deborah.img_0 = '<clipPath id="{randId}"><rect fill="#ffffff" stroke="#E68E58" stroke-width="1" x="5" y="5" rx="15" ry="15" width="140" height="140"></rect></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="5" y="5"  width="140" height="140"></image><rect x="3" y="5" height="30" width="144" fill="#E68E58" opacity="0.5" rx="3" ry="3"></rect><rect x="3" y="115" height="30" width="144" fill="#E68E58" opacity="0.5" rx="3" ry="3"></rect>', OrgChart.templates.deborah.field_0 = '<text width="125" text-overflow="ellipsis" style="font-size: 18px;" fill="#ffffff" x="15" y="25" text-anchor="start">{val}</text>', OrgChart.templates.deborah.field_1 = '<text width="105" text-overflow="ellipsis" style="font-size: 11px;" fill="#ffffff" x="15" y="135" text-anchor="start">{val}</text>', OrgChart.templates.deborah.nodeMenuButton = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,125,130)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>', OrgChart.ui = {
    _defsIds: {},
    defs: function(t) {
        var e = "";
        for (var r in OrgChart.templates) {
            var i = OrgChart.templates[r];
            i.defs ? (OrgChart.ui._defsIds[r] = OrgChart._randomId(), e += i.defs.replace("{randId}", OrgChart.ui._defsIds[r])) : e += i.defs
        }
    ...
    pointer: function(t, e, r) {
        return e === OrgChart.action.exporting ? "" : OrgChart.t(t.template, r).pointer
    },
    node: function(t, e, r, i, a, o, n, l, s, h) {
        var d = OrgChart.t(t.templateName, s),
            c = d.node.replaceAll("{w}", t.w).replaceAll("{h}", t.h);
        if (d.defs && (c = c.replace("{randId}", OrgChart.ui._defsIds[t.templateName])), null == n && (n = i.nodeBinding), t.isGroup) {
            var g = i.tags[t.id].groupName;
            if (g) {
                var p = d.groupName.replace("{elastic_width}", t.w - (d.groupPadding[3] + d.groupPadding[1] + 45));
                g = OrgChart.wrapText(g, p), c += p.replace("{val}", g).replaceAll("{randId}", OrgChart._randomId()).replaceAll("{randId2}", OrgChart._randomId())
            }
        } else
            for (var f in n) {
                var u = n[f];
                if (e) {
                    var C = e[u];
                    if ("function" == typeof u && (C = u(h, t)), null != C && null != C && null != d[f]) c += (OrgChart._lblIsImg(i, f) || "string" != typeof C || (C = OrgChart.wrapText(C, d[f])), d[f].replace("{val}", C)).replaceAll("{randId}", OrgChart._randomId()).replaceAll("{randId2}", OrgChart._randomId())
                }
            }
        var m = OrgChart._getPosition(r, t, a, o),
            O = "node";
        Array.isArray(t.tags) && t.tags.length && (O += " " + t.tags.join(" ")), t.layout && (O += " tree-layout");
        var v = OrgChart.nodeOpenTag.replace("{id}", t.id).replace("{class}", O).replace("{level}", t.level).replace("{x}", m.x).replace("{y}", m.y),
            x = OrgChart._getOpacity(r, t);
        v = v.replace("{opacity}", x), t.isGroup || null == i.nodeMenu || "split" == t.templateName || l === OrgChart.action.exporting || (c += d.nodeMenuButton.replace("{id}", t.id));
        var y = OrgChart.ui._renderGroupedNodes(t, d, i, r, n, a, o, l, s, h);
        return t.isGroup && l != OrgChart.action.exporting && (t.groupState == OrgChart.EXPAND ? c += OrgChart.MINIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id) : c += OrgChart.MAXIMIZE.replace("{x}", t.w - 45).replace("{id}", t.id)), c = v + c + y + OrgChart.grCloseTag
    },
    _renderGroupedNodes: function(t, e, r, i, a, o, n, l, s, h) {
        var d = "";
        if (t.isGroup && t.groupState == OrgChart.EXPAND) {
            e.groupPadding || console.error("groupPadding is not defined in template " + t.templateName);
            for (var c = 0; c < t.bgnodes.length; c++) {
                for (var g = t.bgnodes[c], p = null, f = 0; f < r.nodes.length; f++) r.nodes[f].id == g.id && (p = r.nodes[f]);
                d += OrgChart.ui.node(g, p, i, r, o, n, a, l, s, h)
            }
            d = OrgChart.groupNodesOpenTag.replace("{x}", e.groupPadding[3]).replace("{y}", e.groupPadding[0]) + d + OrgChart.grCloseTag
        }
        return d
    },
    expandCollapse: function(t, e, r, i) {
        ...
        return o -= l.expandCollapseSize / 2, n -= l.expandCollapseSize / 2, t.collapsedChildrenIds.length ? (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", n), a += l.plus) : (a += OrgChart.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", n), a += l.minus), a += OrgChart.grCloseTag
    },
    link: function(t, e, r, i) {
        var a = OrgChart.t(t.templateName, i),
            o = [],
            n = r.levelSeparation / 2;
        t.layout != OrgChart.mixed && t.layout != OrgChart.tree || (n = r.mixedHierarchyNodesSeparation / 2);
        for (var l = 0; l < t.children.length; l++) {
            ...
            if ((s.isAssistant || 2 == s.layout) && s.rightNeighbor && "split" == s.rightNeighbor.templateName) switch (r.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                    ...
                    case OrgChart.orientation.left_top:
                        h = OrgChart.ui._linkBottomToTop(s.rightNeighbor, s, a, n)
                } else if ((s.isAssistant || 2 == s.layout) && s.leftNeighbor && "split" == s.leftNeighbor.templateName) switch (r.orientation) {
                    case OrgChart.orientation.top:
                    case OrgChart.orientation.top_left:
                ...
                d = d.replace("{xa}", h.xa).replace("{ya}", h.ya).replace("{xb}", h.xb).replace("{yb}", h.yb).replace("{xc}", h.xc).replace("{yc}", h.yc).replace("{xd}", h.xd).replace("{yd}", h.yd), o.push(OrgChart.linkOpenTag.replace("{id}", t.id).replace("{class}", "link " + s.tags.join(" ")).replace("{level}", t.level).replace("{child-id}", s.id)), o.push(d);
            var c = "";
            for (var g in r.linkBinding) {
                ...
                if (f) {
                    var u = f[p];
                    null != u && null != u && null != a[g] && (c += a[g].replace("{val}", u))
                }
            }
            "" != c && (c = OrgChart.linkFieldsOpenTag.replace("{x}", h.x).replace("{y}", h.y).replace("{rotate}", 0) + c + OrgChart.grCloseTag, o.push(c)), o.push(OrgChart.grCloseTag)
        }
        return o.join("")
    },
    svg: function(t, e, r, i, a, o) {
        return OrgChart.t(i.template, o).svg.replace("{w}", t).replace("{h}", e).replace("{viewBox}", r).replace("{content}", a)
    },
    exportMenuButton: function(t) {
        return null == t.menu ? "" : OrgChart.t(t.template).exportMenuButton.replaceAll("{p}", t.padding)
    },
    _linkTopToBottom: function(t, e, r, i) {
        var a, o, n, l, s, h, d, c = 0;
        return a = t.x + t.w / 2 + r.linkAdjuster.toX, o = t.y + t.h + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + r.linkAdjuster.fromY, {
            xa: n = a,
            ya: o,
            xb: n,
            yb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y + t.rightNeighbor.h + i : "split" != t.templateName || !e.isAssistant && 2 != e.layout ? "split" == e.templateName ? o + i : h - i : h,
            xc: d = l,
            yc: c,
            xd: s,
            yd: h,
    ...
    _linkBottomToTop: function(t, e, r, i) {
        var a, o, n, l, s, h, d, c = 0;
        return a = t.x + t.w / 2 + r.linkAdjuster.toX, o = t.y + r.linkAdjuster.toY, s = l = e.x + e.w / 2 + r.linkAdjuster.fromX, h = e.y + e.h + r.linkAdjuster.fromY, {
            xa: n = a,
            ya: o,
            xb: n,
            yb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.y - i : "split" != t.templateName || !e.isAssistant && 2 != e.layout ? "split" == e.templateName ? o - i : h + i : h,
            xc: d = l,
            yc: c,
            xd: s,
            yd: h,
    ...
    _linkRightToLeft: function(t, e, r, i) {
        var a, o, n, l, s, h, d, c = 0;
        return a = t.x + r.linkAdjuster.toX, o = t.y + t.h / 2 + r.linkAdjuster.toY, s = e.x + e.w + r.linkAdjuster.fromX, h = l = e.y + e.h / 2 + r.linkAdjuster.fromY, {
            xa: a,
            ya: n = o,
            xb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.x - i : "split" != t.templateName || !e.isAssistant && 2 != e.layout ? "split" == e.templateName ? a - i : s + i : s,
            yb: n,
            xc: c,
            yc: d = l,
            xd: s,
    ...
    _linkLeftToRight: function(t, e, r, i) {
        var a, o, n, l, s, h, d, c = 0;
        return a = t.x + t.w + r.linkAdjuster.toX, o = t.y + t.h / 2 + r.linkAdjuster.toY, s = e.x + r.linkAdjuster.fromX, h = l = e.y + e.h / 2 + r.linkAdjuster.fromY, {
            xa: a,
            ya: n = o,
            xb: c = t.rightNeighbor && t.rightNeighbor.isAssistant && "split" == e.templateName ? t.rightNeighbor.x + t.rightNeighbor.w + i : "split" != t.templateName || !e.isAssistant && 2 != e.layout ? "split" == e.templateName ? a + i : s - i : s,
            yb: n,
            xc: c,
            yc: d = l,
            xd: s,
...
}, OrgChart.getScale = function(t, e, r, i, a, o) {
    if (!t && i === OrgChart.match.boundary) return (n = r / o) < (l = e / a) ? n : l;
    if (!t && i === OrgChart.match.width) return e / a;
    if (t || i !== OrgChart.match.height) {
        if (t) {
            var n, l = e / t[2];
            return (n = r / t[3]) < l ? n : l
        }
        return i
    }
    return r / o
    ...
    e.className = "bg-ripple-container", n.addEventListener("mousedown", function(t) {
        var e, r, i, a, o;
        return r = document.createElement("span"), i = this.offsetWidth, e = this.getBoundingClientRect(), o = t.pageX - e.left - i / 2, a = "top:" + (t.pageY - e.top - i / 2) + "px; left: " + o + "px; height: " + i + "px; width: " + i + "px;", n.rippleContainer.appendChild(r), r.setAttribute("style", a)
    }), n.addEventListener("mouseup", (r = function() {
    ...
    })), n.rippleContainer = e, n.appendChild(e)
    ...
    var i = t.getBoundingClientRect(),
        ...
        n = i.left - a.left,
        l = i.top - a.top;
    return i.top + o.height > a.top + a.height && (l -= o.height), i.left - o.width < a.left && (n += o.width), {
        x: n,
        y: l
    }
    ...
    for (var r = 0; r < t.length; r++) {
        var i = e[t[r]];
        if (i && i.group && i.template) return {
            tag: i,
            name: t[r]
        }
    }
    ...
    var e = document.querySelector("#bg-tests");
    ...
    if (!l) return t;
    if (l = parseFloat(l), a || (a = 0), o || (o = 0), a || (n = "start"), s || (s = "ellipsis"), "ellipsis" == s) {
        d.removeChild(d.firstChild), d.textContent = t;
        for (var c = d.getComputedTextLength(), g = 2; l < c;) d.textContent = t.substring(0, t.length - g), d.textContent += "...", c = d.getComputedTextLength(), g++;
    ...
    if ("multiline" == s) {
        ...
        u.setAttributeNS(null, "x", a), u.setAttributeNS(null, "y", o), u.setAttributeNS(null, "text-anchor", n), u.appendChild(C), d.appendChild(u);
        g = 1;
        for (var m = 1; m < p.length; m++) {
            var O = u.firstChild.data.length;
            if (u.firstChild.data += " " + p[m], u.getComputedTextLength() > l) u.firstChild.data = u.firstChild.data.slice(0, O), (u = document.createElementNS(h, "tspan")).setAttributeNS(null, "x", a), u.setAttributeNS(null, "y", o + f * g), u.setAttributeNS(null, "text-anchor", n), C = document.createTextNode(p[m]), u.appendChild(C), d.appendChild(u), g++
        }
        var v = "";
        if (null != d.innerHTML) v = d.innerHTML, d.innerHTML = "";
        else {
            var x = "";
            for (m = d.childNodes.length - 1; 0 <= m; m--) x = XMLSerializer().serializeToString(d.childNodes[m]) + x, d.removeChild(d.childNodes[m]);
            v = x
        }
        return v
    }
    ...
    if (navigator.msSaveBlob) navigator.msSaveBlob(i, r);
        ...
        if (void 0 !== a.download) {
            ...
            a.setAttribute("href", o), a.setAttribute("download", r), a.style.visibility = "hidden", document.body.appendChild(a), a.click(), document.body.removeChild(a)
        }
    }
    ...
    if (null != r && (a.x = r), null != i && (a.y = i), t && 3 == t.length) {
        var o = t[0].indexOf(e.id); - 1 != o && null != t[1][o].transform && (null == r && (a.x = t[1][o].transform[4]), null == i && (a.y = t[1][o].transform[5]))
    }
    return a
    ...
    for (var r = new RegExp("(\\" + e + '|\\r?\\n|\\r|^)(?:"([^"]*(?:""[^"]*)*)"|([^"\\' + e + "\\r\\n]*))", "gi"), i = [
        ...
        var o, n = a[1];
        n.length && n !== e && i.push([]), o = a[2] ? a[2].replace(new RegExp('""', "g"), '"') : a[3], i[i.length - 1].push(o)
    }
    return i
    ...
    for (var o = [], e = function(t) {
            for (var e = "", r = 0; r < o.length; r++) {
                var i;
                (i = "reportsTo" == o[r] ? null : null == t[o[r]] ? "" : t[o[r]]) instanceof Date && (i = i.toLocaleString());
                var a = (i = null === i ? "" : i.toString()).replace(/"/g, '""');
                0 <= a.search(/("|,|\n)/g) && (a = '"' + a + '"'), 0 < r && (e += ","), e += a
            }
            return e + "\n"
        }, r = "", i = 0; i < t.length; i++)
        for (var a in t[i]) OrgChart._arrayContains(o, a) || (o.push(a), r += a + ",");
    r += "\n";
    for (i = 0; i < t.length; i++) r += e(t[i]);
    return r
}, OrgChart.accentFold = function(t) {
    return (t = t.toString().toLowerCase()).replace(/([àáâãäå])|([ç])|([èéêë])|([ìíîï])|([ñ])|([òóôõöø])|([ß])|([ùúûü])|([ÿ])|([æ])/g, function(t, e, r, i, a, o, n, l, s, h, d) {
        return e ? "a" : r ? "c" : i ? "e" : a ? "i" : o ? "n" : n ? "o" : l ? "s" : s ? "u" : h ? "y" : d ? "ae" : void 0
    })
    ...
    return t.msie && OrgChart.scroll.ie ? OrgChart.scroll.ie : t.edge && OrgChart.scroll.edge ? OrgChart.scroll.edge : t.safari && OrgChart.scroll.safari ? OrgChart.scroll.safari : t.chrome && OrgChart.scroll.chrome ? OrgChart.scroll.chrome : t.firefox && OrgChart.scroll.firefox ? OrgChart.scroll.mozilla : t.opera && OrgChart.scroll.opera ? OrgChart.scroll.opera : {
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        ! function(t, i, e) {
            ...
            function o() {
                ...
                0 < t ? t++ : t--, n.bar.scrollLeft += t, n.bar.scrollLeft == n.pos ? a = !1 : r(o)
            }
            t.addEventListener("wheel", function(t) {
                var e = 0;
                if (n.config.mouseScrool == OrgChart.action.xScroll)(e = t.deltaX || t.wheelDeltaX) || (e = t.deltaY || t.wheelDeltaY);
                else if (n.config.mouseScrool == OrgChart.action.scroll && !(e = t.shiftKey ? t.deltaY || t.wheelDeltaY : t.deltaX || t.wheelDeltaX)) return;
                e = -e, t.preventDefault(), e = Math.max(-1, Math.min(1, e)), n.pos += -e * i;
                var r = parseFloat(n.innerBar.clientWidth) - parseFloat(n.bar.clientWidth);
    ...
    if (this.bar) {
        var t = this.requestParams(),
            e = (t.boundary.maxY, t.scale, Math.abs(t.boundary.maxX - t.boundary.minX) * t.scale);
        ...
        i < 0 ? i = 0 : 100 < i && (i = 100);
        var a = i * ((parseFloat(this.innerBar.clientWidth) - parseFloat(this.bar.clientWidth)) / 100);
        this.bar.ignore = !0, this.bar.scrollLeft = a, this.pos = this.bar.scrollLeft
    }
    ...
    if (this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) {
        ...
        ! function(t, i, e) {
            ...
            function o() {
                ...
                0 < t ? t++ : t--, n.bar.scrollTop += t, n.bar.scrollTop == n.pos ? a = !1 : r(o)
            }
            t.addEventListener("wheel", function(t) {
                var e = 0;
                if (n.config.mouseScrool == OrgChart.action.yScroll)(e = t.deltaY || t.wheelDeltaY) || (e = t.deltaX || t.wheelDeltaX);
                else if (n.config.mouseScrool == OrgChart.action.scroll && !(e = t.shiftKey ? t.deltaX || t.wheelDeltaX : t.deltaY || t.wheelDeltaY)) return;
                e = -e, t.preventDefault(), e = Math.max(-1, Math.min(1, e)), n.pos += -e * i;
                var r = parseFloat(n.innerBar.clientHeight) - parseFloat(n.bar.clientHeight);
                n.pos < 0 && (n.pos = 0), n.pos > r && (n.pos = r), a || o()
            }, !1);
            var r = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
                setTimeout(t, 20)
    ...
    if (this.bar) {
        ...
        i < 0 ? i = 0 : 100 < i && (i = 100);
        var a = i * ((parseFloat(this.innerBar.clientHeight) - parseFloat(this.bar.clientHeight)) / 100);
        this.bar.ignore = !0, this.bar.scrollTop = a, this.pos = this.bar.scrollTop
    }
    ...
    var i = this.getViewBox().slice(0),
        ...
        o = i[2],
        n = i[3];
    !0 === t ? (i[2] = i[2] / OrgChart.SCALE_FACTOR, i[3] = i[3] / OrgChart.SCALE_FACTOR) : !1 === t ? (i[2] = i[2] * OrgChart.SCALE_FACTOR, i[3] = i[3] * OrgChart.SCALE_FACTOR) : (i[2] = i[2] / t, i[3] = i[3] / t), e || (e = [50, 50]), i[0] = a[0] - (i[2] - o) / (100 / e[0]), i[1] = a[1] - (i[3] - n) / (100 / e[1]);
    ...
    if (i[2] = this.width() / l, i[3] = this.height() / l, !0 === t && l < this.config.scaleMax || !1 === t && l > this.config.scaleMin || 0 != t && 1 != t && l < this.config.scaleMax && l > this.config.scaleMin) {
        this._hideBeforeAnimation();
        var s = this;
        r ? (clearTimeout(s._timeout), OrgChart.anim(this.getSvg(), {
    ...
    var e = document.createElement("div");
    e.id = "bg-loading", e.innerHTML = '<style>@-webkit-keyframes dot-keyframes {0% { opacity: .4; -webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}@keyframes dot-keyframes {0% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}.bg-loading-dots div {margin: 10px;}      .bg-dot-1 {background-color: #E68E58;}.bg-dot-2 {background-color: #F57C00;}.bg-dot-3 {background-color: #FFCA28;}      .bg-loading-dots {text-align: center;width: 100%; position: absolute; top: 0;}.bg-loading-dots--dot {-webkit-animation: dot-keyframes 1.5s infinite ease-in-out;animation: dot-keyframes 1.5s infinite ease-in-out;        border-radius: 10px;display: inline-block;height: 10px;width: 10px;}.bg-loading-dots--dot:nth-child(2) {-webkit-animation-delay: .5s;animation-delay: .5s;}.bg-loading-dots--dot:nth-child(3) {-webkit-animation-delay: 1s;animation-delay: 1s;}</style><div class="bg-loading-dots"><div class="bg-loading-dots--dot bg-dot-1"></div><div class="bg-loading-dots--dot bg-dot-2"></div><div class="bg-loading-dots--dot bg-dot-3"></div></div>', t.element.appendChild(e)
}, OrgChart.loading.hide = function(t) {
    var e = t.element.querySelector("#bg-loading");
    e && e.parentNode.removeChild(e)
}, OrgChart.pdfPrevUI = {}, OrgChart.loc || (OrgChart.loc = {}), OrgChart.loc.ppdfCmdTitle = "PDF Preview", OrgChart.loc.ppdfSave = "Save", OrgChart.loc.ppdfCancel = "Cancel", OrgChart.loc.ppdfFormat = "Format", OrgChart.loc.ppdfFitToDrwaing = "Fit", OrgChart.loc.ppdfFitToDrwaing2Levels = "Fit (2 Levels Page)", OrgChart.loc.ppdfA4 = "A4", OrgChart.loc.ppdfA3 = "A3", OrgChart.loc.ppdfA2 = "A2", OrgChart.loc.ppdfA1 = "A1", OrgChart.loc.ppdfA42Levels = "A4 (2 Levels Page)", OrgChart.loc.ppdfA32Levels = "A3 (2 Levels Page)", OrgChart.loc.ppdfA22Levels = "A2 (2 Levels Page)", OrgChart.loc.ppdfA12Levels = "A1 (2 Levels Page)", OrgChart.loc.ppdfLayout = "Layout", OrgChart.loc.ppdfPortrait = "Portrait", OrgChart.loc.ppdfLandscape = "Landscape", OrgChart.loc.ppdfFittopagewidth = "Fit to page width", OrgChart.loc.ppdfMargin = "Margin", OrgChart.loc.ppdfHeader = "Header", OrgChart.loc.ppdfFooter = "Footer", OrgChart.loc.ppdfScale = "Scale", OrgChart.pdfPrevUI.show = function(r, i) {
    ...
    var a, o, n, l = r.element.querySelector("#bg-ppdf-size"),
    ...
    l.value = i.format, s.value = i.landscape, h.value = i.scale, d.value = i.margin, c.value = i.header, g.value = i.footer, OrgChart.anim(r.element.querySelector("#bg-ppdf-btns"), {
        margin: [0, 0, 0, -250]
    }, {
        margin: [0, 0, 0, 0]
        ...
        OrgChart.anim(r.element.querySelector("#bg-ppdf-content"), {
            opacity: 1
        }, {
            opacity: 0
    ...
    "A4" == t.value || "A3" == t.value || "A2" == t.value || "A1" == t.value ? (e.parentNode.style.display = "block", r.parentNode.style.display = "block") : ("A42Levels" == t.value || "A32Levels" == t.value || "A22Levels" == t.value || "A12Levels" == t.value ? e.parentNode.style.display = "block" : e.parentNode.style.display = "none", r.parentNode.style.display = "none")
    ...
    for (var s = l.querySelector("svg"), h = t.element.querySelector("#bg-ppdf-content"), d = 0; d < a.length; d++) {
        ...
        var f = i.footer;
        a[d].footer && (f = a[d].footer), f && (f = f.replace("{current-page}", d + 1).replace("{total-pages}", a.length)), a[d].html ? g.write(OrgChart._exportHtml(a[d].html, i, a[d].innerSize.w, a[d].innerSize.h, p, f)) : (s.setAttribute("viewBox", a[d].vb), g.write(OrgChart._exportHtml(l.innerHTML, i, a[d].innerSize.w, a[d].innerSize.h, p, f)));
    ...
    var s = '<!DOCTYPE html><html style="margin:0;padding:0;"><head></head><body style="margin:0; padding:0;"><div style="margin: ' + n + ";overflow:hidden;width:" + r + "px;height:" + i + 'px">';
    return a && (s += '<div id="bg-header" style="width:' + r + "px;color:#757575;position:absolute;left:" + e.margin[3] + 'px;top:0;">' + a + "</div>"), s += t, o && (s += '<div id="bg-footer" style="width:' + r + "px;color:#757575;position:absolute;left:" + e.margin[3] + 'px;bottom:0;">' + o + "</div>"), s += "</div>", s += "</body></html>"
    ...
    for (var r, i, a, o, n, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (e.res.visibleNodes[h.from] && e.res.visibleNodes[h.to]) {
            var d = t.getBGNode(h.from),
                c = t.getBGNode(h.to),
                g = d.x,
                p = d.y,
                f = c.x,
            ...
            if (c.isChildOfGroup) {
                C = t.getBGNode(c._groupParentNodeId), m = OrgChart.t(C.templateName);
            ...
            switch (this.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    x <= y ? (_ = 1, O.x = x + d.w / 10, v.x = y - c.w / 10) : (_ = -1, O.x = x - d.w / 10, v.x = y + c.w / 10), p == u ? (_ = 1, O.y = p, v.y = u) : u < p ? (O.y = p, v.y = u + c.h) : (O.y = p + d.h, v.y = u);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    O.x = x <= y ? (_ = -1, x + d.w / 10) : (_ = 1, x - d.w / 10), v.x = y + c.w / 10, p == u ? (_ = -1, O.y = p + d.h, v.y = u + c.h) : u < p ? (O.y = p, v.y = u + c.h) : (O.y = p + d.h, v.y = u);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    O.y = b <= w ? (_ = -1, b + d.h / 5) : (_ = 1, b - d.h / 5), v.y = w + c.h / 5, g == f ? (_ = -1, O.x = g, v.x = f) : f < g ? (O.x = g, v.x = f + c.w) : (O.x = g + d.w, v.x = f);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    O.y = b <= w ? (_ = 1, b + d.h / 5) : (_ = -1, b - d.h / 5), v.y = w + c.h / 5, g == f ? (_ = 1, O.x = g + d.w, v.x = f + c.w) : f < g ? (O.x = g, v.x = f + c.w) : (O.x = g + d.w, v.x = f)
            }
            var k = I(O, v, _),
                A = h.template;
            A || (A = "orange");
            m = OrgChart.clinkTemplates[A];
            l += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", d.id).replace("{to}", c.id) + m.link.replace("{d}", "M{a.x},{a.y} C{a.x},{a.y} {c.x},{c.y} {b.x},{b.y}").replaceAll("{b.x}", v.x).replaceAll("{b.y}", v.y).replaceAll("{a.x}", O.x).replaceAll("{a.y}", O.y).replaceAll("{c.x}", k.x).replaceAll("{c.y}", k.y);
            var S = (r = O, a = k, void 0, o = ((i = v).x - r.x) / 2 + r.x, n = (i.y - r.y) / 2 + r.y, {
                x: (o - a.x) / 2 + a.x,
                y: (n - a.y) / 2 + a.y
            });
            h.label && (l += m.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", h.label)), l += OrgChart.grCloseTag
        }
        ...
        function I(t, e, r) {
            ...
            return o = o / (Math.sqrt(i * i + a * a) * r) * OrgChart.CLINK_CURVE, {
                x: t.x + i / 2 - a * o,
                y: t.y + a / 2 + i * o
            }
        }
    ...
    defs: '<marker id="arrowBlue" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#E68E58" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotBlue" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#E68E58" /></marker>',
    link: '<path marker-start="url(#dotBlue)" marker-end="url(#arrowBlue)" stroke="#E68E58" stroke-width="2" fill="none" d="{d}" />',
    label: '<text fill="#E68E58"  text-anchor="middle" x="{x}" y="{y}">{val}</text>'
    ...
    t._slinks(t, e)
}), OrgChart.prototype._slinks = function(w, _) {
    var k = "",
        A = this.getScale(),
        S = _.res.boundary;
    ...
    function t(t, e) {
        ...
        switch (w.config.orientation) {
            ...
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                a = "top", e.y > t.y && (a = "bottom")
        }
        var o = OrgChart.t(t.templateName, A),
            n = w.config.levelSeparation;
        (t.parent && t.parent.layout == OrgChart.mixed || t.parent.layout == OrgChart.tree) && (n = w.config.mixedHierarchyNodesSeparation);
        var l = {
            p: t.x + t.w / 2 + o.expandCollapseSize,
            q: t.y,
            r: t.x + t.w / 2 + o.expandCollapseSize,
            s: S.minY + n
        };
        if (t.level == e.level) switch (i = e, w.config.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
                r.push([l.p, l.q]), r.push([l.p, l.q - n / 3]), o = OrgChart.t(i.templateName, A), r.push([i.x + i.w / 2 + o.expandCollapseSize, r[r.length - 1][1]]), r.push([r[r.length - 1][0], i.y]);
                break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
                l.q = t.y + t.h, l.s = S.maxY - n, r.push([l.p, l.q]), r.push([l.r, t.y + t.h + n / 3]), o = OrgChart.t(i.templateName, A), r.push([i.x + i.w / 2 + o.expandCollapseSize, r[r.length - 1][1]]), r.push([r[r.length - 1][0], i.y + i.h]);
                break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
                l.p = t.x, l.q = t.y + t.h / 2 + o.expandCollapseSize, l.r = S.minX - n, l.s = t.y + t.h / 2 + o.expandCollapseSize, r.push([l.p, l.q]), r.push([t.x - n / 3, l.q]), o = OrgChart.t(i.templateName, A), r.push([r[r.length - 1][0], i.y + i.h / 2 + o.expandCollapseSize]), r.push([i.x, r[r.length - 1][1]]);
                break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
                l.p = t.x + t.w, l.q = t.y + t.h / 2 + o.expandCollapseSize, l.r = S.maxX + n, l.s = t.y + t.h / 2 + o.expandCollapseSize, r.push([l.p, l.q]), r.push([t.x + t.w + n / 3, l.q]), o = OrgChart.t(i.templateName, A), r.push([r[r.length - 1][0], i.y + i.h / 2 + o.expandCollapseSize]), r.push([i.x + i.w, r[r.length - 1][1]])
        } else {
            switch (w.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    r.push([l.p, l.q]), r.push([l.r, t.y - n / 3]);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    l.q = t.y + t.h, l.s = S.maxY - n, r.push([l.p, l.q]), r.push([l.r, t.y + t.h + n / 3]);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    l.p = t.x, l.q = t.y + t.h / 2 + o.expandCollapseSize, l.r = S.minX - n, l.s = t.y + t.h / 2 + o.expandCollapseSize, r.push([l.p, l.q]), r.push([t.x - n / 3, l.q]);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    l.p = t.x + t.w, l.q = t.y + t.h / 2 + o.expandCollapseSize, l.r = S.maxX + n, l.s = t.y + t.h / 2 + o.expandCollapseSize, r.push([l.p, l.q]), r.push([t.x + t.w + n / 3, l.q])
            }
            for (var s = t; null == i;) {
                var h = !1,
                    d = s.parent,
                    c = d.leftNeighbor,
                    g = d.rightNeighbor;
                if (d.id == e.id ? i = d : OrgChart._intersects(d, l, w.config) && (l = OrgChart._addPoint(d, r, w.config, l, a), h = !0), d.id != e.id) {
                    for (; c;) {
                        if (c.id == e.id) {
                            i = c;
                            break
                        }
                        OrgChart._intersects(c, l, w.config) && (l = OrgChart._addPoint(c, r, w.config, l, a), h = !0), c = c.leftNeighbor
                    }
                    for (; g;) {
                        if (g.id == e.id) {
                            i = g;
                        ...
                        OrgChart._intersects(g, l, w.config) && (l = OrgChart._addPoint(g, r, w.config, l, a), h = !0), g = g.rightNeighbor
                    }
                }
                if (!h) {
                    var p = r[r.length - 1][0],
                        f = 0;
                    if (d.parent) switch (n = w.config.levelSeparation, d.parent.layout != OrgChart.mixed && d.parent.layout != OrgChart.tree || (n = w.config.mixedHierarchyNodesSeparation), w.config.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            f = d.parent.y + d.parent.h + n * (2 / 3);
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            f = d.parent.y - n * (2 / 3);
                        ...
                        case OrgChart.orientation.left:
                        case OrgChart.orientation.left_top:
                            p = d.parent.x + d.parent.w + n * (2 / 3), f = r[r.length - 1][1];
                            break;
                        case OrgChart.orientation.right:
                        case OrgChart.orientation.right_top:
                            p = d.parent.x - n * (2 / 3), f = r[r.length - 1][1]
                    }
                    r.push([p, f])
                }
                s = d
            }
            switch (o = OrgChart.t(i.templateName, A), r.splice(r.length - 1, 1), w.config.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    r.push([i.x + i.w / 2 + o.expandCollapseSize, r[r.length - 1][1]]), r.push([r[r.length - 1][0], i.y + i.h]);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    r.push([i.x + i.w / 2 + o.expandCollapseSize, r[r.length - 1][1]]), r.push([r[r.length - 1][0], i.y]);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    r.push([r[r.length - 1][0], i.y + i.h / 2 + o.expandCollapseSize]), r.push([i.x + i.w, r[r.length - 1][1]]);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    r.push([r[r.length - 1][0], i.y + i.h / 2 + o.expandCollapseSize]), r.push([i.x, r[r.length - 1][1]])
            }
        }
        var u = I.template;
        u || (u = "orange");
        var C = null;
        switch ((o = OrgChart.slinkTemplates[u]).labelPosition) {
            case "start":
                C = {
                    x: r[1][0],
                    y: r[1][1]
        ...
        r[0] = "M" + r[0].join(",");
        for (var O = 1; O < r.length; O++) r[O] = "L" + r[O].join(",");
        var v = r.join(" ");
        if (k += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + o.link.replace("{d}", v), I.label) {
            var x = o.label.replace("{x}", C.x).replace("{y}", C.y).replace("{val}", I.label),
                y = OrgChart._getLabelSize(x),
                b = -y.height / 2;
            switch (w.config.orientation) {
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
            ...
            k += o.label.replace("{x}", C.x).replace("{y}", C.y + b).replace("{val}", I.label)
        }
        k += OrgChart.grCloseTag, _.content += k
    }
    for (var e = 0; e < this.config.slinks.length; e++) {
        var I = this.config.slinks[e];
        if (_.res.visibleNodes[I.from] && _.res.visibleNodes[I.to]) {
            var r = w.getBGNode(I.from),
                i = w.getBGNode(I.to);
            r.level >= i.level ? t(r, i) : t(i, r)
        }
    }
    ...
    defs: '<marker id="arrowSlinkBlue" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse"><path fill="#E68E58" d="M 0 0 L 10 5 L 0 10 z" /></marker><marker id="dotSlinkBlue" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="5" markerHeight="5"> <circle cx="5" cy="5" r="5" fill="#E68E58" /></marker>',
    link: '<path stroke-dasharray="4, 2" marker-start="url(#dotSlinkBlue)" marker-end="url(#arrowSlinkBlue)" stroke-linejoin="round" stroke="#E68E58" stroke-width="2" fill="none" d="{d}" />',
    label: '<text fill="#E68E58" text-anchor="middle" x="{x}" y="{y}">{val}</text>',
    labelPosition: "middle"
