							...
							<div class="featured-item style-2" id="">
								<form role="form" action="{{ route('ppid.layanan.permohonan_informasi.buat') }}" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group row">
										<label for="nik" class="col-md-3 col-form-label text-md-left">{{ __('NIK') }}</label>
										<div class="col-md-9">
											<input id="form_name" type="text" name="nik" class="form-control" disabled="disabled" style="background-color:#bbb4ce;" value={{ Auth::user()->nik }} >
											<div class="help-block with-errors" ></div>
										</div>
									</div>
										
									<div class="form-group row">
										<label for="nik" class="col-md-3 col-form-label text-md-left">{{ __('Nama') }}</label>
										<div class="col-md-9">
											<input id="form_name" type="text" name="nama" class="form-control" disabled="disabled" style="background-color:#bbb4ce;" value={{ Auth::user()->name }} >
											<div class="help-block with-errors" ></div>
										</div>
									</div>
									
									<div class="form-group row">
										<label for="nik" class="col-md-3 col-form-label text-md-left">{{ __('Email') }}</label>
										<div class="col-md-9">
											<input id="form_name" type="email" name="email" class="form-control" disabled="disabled" style="background-color:#bbb4ce;" value={{ Auth::user()->email }} >
											<div class="help-block with-errors" ></div>
										</div>
									</div>
									
									<div class="form-group row">
										<label for="nik" class="col-md-3 col-form-label text-md-left">{{ __('No. Telepon') }}</label>
										<div class="col-md-9">
											<input id="form_name" type="text" name="telp" class="form-control" value={{ Auth::user()->telp }}>
											<div class="help-block with-errors" ></div>
										</div>
									</div>
									
									<div class="form-group row">
										<label for="nik" class="col-md-3 col-form-label text-md-left">{{ __('Jenis Kelamin') }}</label>
										<div class="col-md-9">
											<tr>
												<td>
									...
									<div class="form-group row">
										<label for="nik" class="col-md-3 col-form-label text-md-left">{{ __('Jenis Alamat') }}</label>
										<div class="col-md-9">
											<tr>
												<td>
													<select name="jenis_alamat" class="form-control">
														@if ( Auth::user()->jenis_alamat === "Kantor" )
									...
									<div class="form-group row">
										<label for="nik" class="col-md-3 col-form-label text-md-left">{{ __('Alamat') }}</label>
										<div class="col-md-9">
											<input id="form_name" type="text" name="alamat" class="form-control" value={{ Auth::user()->alamat }}>
											<div class="help-block with-errors" ></div>
										</div>
									</div>
									...
									<div class="form-group row pt-3 mb-0">
										<div class="col-md-6 offset-md-3">
											<button type="submit" class="btn" style="background:#049372; color:#fff;">
												{{ __('Ubah') }}
											</button>
										</div>
									</div>
