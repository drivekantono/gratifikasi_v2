            ...
            <div class="container">
              <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 order-lg-1 md-mt-5">
                  <h1 class=" text-white animated bounceInLeft delay-2 duration-3">MATERI</h1>
                </div>        
              </div>
            </div>
           </div>
         ...
         <div class="card">
            ...
            <div id="key" class="collapse" data-parent="#accordion">
              <div class="card-body">{!!$item->deskripsi!!} 
                <a target="_blank" href="{{asset('uploads/download_materi/'.$item->file)}}">DOWNLOAD</a>
...
<script>
  function baca_online(id){
    console.log(id);
    var url_php = '{{ route('user.download_materi.show', 'id') }}';
      ...
      dataType: 'json', // added data type
        success: function(res) {
          console.log(res.images);
            ...
            $('#filepdf').attr('src', 'uploads/download_materi/'+res.file);
        }
    })
  }
</script>
