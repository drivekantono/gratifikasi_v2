  ...
  <div class="container">
    ...
    <div class="col-lg-12 col-md-12 md-mt-5">
        ...
        <div class="subscribe-form sm-mt-2">
          <form id="mc-form" class="group" action="{{ route('frontend.kehutanan_dalam_angka.bytahun') }}" method="POST">
            {{ csrf_field() }}
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12">
        <div class="left-side">
          <div class="post">
            <div class="post-desc">
              <div class="post-date mb-2">Kehutanan Dalam Angka Pada Tahun {{ $item->tahun}}</span>                
              </div>
              <p class="lead">{!! $item->title !!}</p>
              <div><span><a href="{{asset('uploads/data_statistika/'.$item->file)}}">Download</a></span></div>
            </div>
          </div>
        </div>
      </div>      
