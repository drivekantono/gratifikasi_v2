        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Spasial Kehutanan</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.hutan_rakyat.update', $items->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <td>
                            @if($items->images != null)
                                <img src="{{ asset('/uploads/hutan_rakyat/'.$items->images) }}" height="30%" width="30%" />
                            @else
                                <p>Tidak ada Image</p>
                            @endif
                        </td>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('admin.hutan_rakyat.index') }}" class="btn btn-success">Cancel</a>
