        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-tahun">Tambah Data Progres Perhutanan Sosial Jawa Timur</h3>
                    @if (count($errors) > 0)
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.pps_jatim.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
