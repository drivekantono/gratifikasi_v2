        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <strong style="font-size: 18pt">Laporan Gratifikasi</strong><br>
                    <strong style="font-size: 12pt">Nomor: {{ $items->pgd_no }}</strong><br><br>
                    <!--
                ...
                <div class="box-body">
                    ...
                    <div class="row" style="padding-left: 15px; padding-right: 15px;">
                        <div class="col-md-2">
                            <strong>Kategori dan Verifikasi</strong>
                        </div>
                        <div class="form-group col-md-4" style="margin-bottom: 0px;">
                            ...
                            @else
                                <!-- <label class="kotak" style="background-color: rgba(94, 238, 118, 0.8);">{{ $items->pgd_kategori }}</label> -->
                                <span class="badge bg-green">{{ $items->pgd_kategori }}</span>
                            @endif

                            @if($items->pgd_verifikasi === "Y")
                                <span class="badge bg-red">Gratifikasi</span>
                            @elseif($items->pgd_verifikasi === "T")
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <fieldset>
                                ...
                                <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                    <div class="col-md-4">
                                        <strong>Unit Kerja dan Instansi</strong>
                                    </div>
                                    <div class="form-group col-md-4">
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                    ...
                                    <div class="form-group col-md-8">
                                        <input type="text" class="form-control" id="pgd_jenis" name="pgd_jenis" disabled value="{{ $items->pgd_jenis }}" style="background-color: #e4f5ff;">
                                    </div>
                                </div>
                                <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                    <div class="col-md-4">
