            ...
            <div class="featured-item" id="" style="padding: 20px;">
              <div class="row">
                <div class="col-md-12 my-2">
                  <strong><i class="fa fa-file-o mr-2"></i> {{ $item->pgf_no }}</strong> &nbsp &nbsp &nbsp
                  <strong><i class="fa fa-calendar-check-o mr-2"></i> {{ $item->pgf_tanggal_lapor }}</strong> </br>
                  <strong><i class="fa fa-tags"></i> {{ $item->pgf_sumber }}</strong> &nbsp &nbsp &nbsp
                  @if($item->pgf_verifikasi === "Y")
                    <span class="badge bg-red">Gratifikasi</span>
                  @elseif($item->pgf_verifikasi === "T")
                    <span class="badge bg-green">Bukan Gratifikasi</span>
                  @else
                    <span class="badge bg-blue">Belum di Verifikasi</span>
                  @endif
                  @if($item->pgf_verifikasi_kirim !== null)
                  ...
                  <table style="width: 100%;">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="width:  5%;">:</td>
                        <td>{{ $item->pgf_pelapor_nik }}</td>
                      </tr>
                      <tr>
                        <td style="width: 30%;">Instansi</td>
                        <td style="width:  5%;">:</td>
                        <td>{{ $item->pgf_pelapor_instansi }}</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style="width:  5%;">:</td>
                        <td>{{ $item->pgf_tanggal }}</td>
                      </tr>
                      <tr>
                        <td style="width: 30%;">Tempat</td>
                        <td style="width:  5%;">:</td>
                        <td>{{ $item->pgf_tempat }}</td>
                      </tr>
                      <tr>
                        <td style="width: 30%;">Uraian</td>
                        <td style="width:  5%;">:</td>
                        <td>{{ $item->pgf_uraian }}</td>
                      </tr>
                      <tr>
                        <td style="width: 30%;">Nominal</td>
                        <td style="width:  5%;">:</td>
                        <td>{{ number_format($item->pgf_nominal, 2, ',', '.') }}</td>
                      </tr>
                    </tbody>
                  </table>
                  <hr style="margin-top: 10px; margin-bottom: 10px; border-top: 1px solid #555;">
            ...
            <tbody>
              @foreach ($items as $item)
                <tr>
                  ...
                  <td>
                    {{ $item->pgf_tanggal_lapor }} </br>
                    {{ $item->pgf_sumber }}
                  </td>
                  <td>
                    <b>Nama : </b>{{ $item->pgf_pelapor_nama }} </br>
                    <b>Instansi : </b>{{ $item->pgf_pelapor_instansi }}
                  </td>
                  <td>
                    {{ $item->pgf_uraian }}
                  </td>
                  <td>
                  {{ number_format($item->pgf_nominal, 2, ',', '.') }}
                  </td>
                  <td>
                    <a target="_blank" href="{{asset('uploads/pelaporan_gratifikasi/'.$item->pgf_lampiran)}}">
                  ...
                  <td>
                    <a href="{!! route('admin.pelaporan_gratifikasi_form.create.pgd', $item->id) !!}" title="tambahkan ke data pelaporan">
                      <button class="btn btn-success" style="height: 30px; width: 115px; text-align: left; text-align: left; margin-bottom: 5px; padding-top: 3px">
                        <i class="fa fa-edit"></i>&nbsp Tambahkan
                      </button>
                    </a>
                  </td>
                </tr>
