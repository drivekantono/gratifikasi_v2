        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Edit Rekapitulasi</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.rekapitulasi.update', $items->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label for="tahun">Judul</label>
                        ...
                        <td>
                            <a href="{{asset('uploads/rekapitulasi/'.$items->file)}}"> File Lama : {{$items->file}}</a>
                        </td>
                    </div>
                    <!-- /.box-body -->
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('admin.rekapitulasi.index') }}" class="btn btn-success">Cancel</a>
