    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.download_materi.update', $items->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <td>
                            <a href="{{ asset('/uploads/download_materi/'.$items->file) }}">{{ $items->file }}</a>
                        </td>
                    </div>
                    <!-- /.box-body -->
