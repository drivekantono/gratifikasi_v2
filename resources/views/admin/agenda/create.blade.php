                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date">
                                ...
                                <input type="text" class="form-control pull-right" id="tanggal_selesai" name="tanggal_selesai">
                            </div>
                            <!-- /.input group -->
                        </div>
                        <!-- /.form group -->
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="lokasi" name="lokasi" placeholder="Enter Lokasi" value=" {{ old('nama_kegiatan') }}">
                        </div>
                        <div class="form-group">
