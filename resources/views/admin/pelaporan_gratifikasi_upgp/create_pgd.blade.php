        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong>Tambah Data Pelaporan Gratifikasi dari Form Unggah</strong></h3></br></br>
                </div>

                <div class="box-body">
                    <div class="col-md-6">
                        <p class="box-title"><strong>Form Unggah</strong></p>
                        <object data="{{asset('uploads/pelaporan_gratifikasi/'.$items_pgf->pgf_lampiran)}}" type="application/pdf" width="100%" height="700px">
                            PDF tidak dapat ditampilkan. <a href="{{asset('uploads/pelaporan_gratifikasi/'.$items_pgf->pgf_lampiran)}}">Unduh PDF</a>.
                        </object>
                    </div>
                    <div class="col-md-6">
                        <p class="box-title"><strong>Form Gratifikasi</strong></p>
                        <div id="scroller">
                            <form name="formGratifikasi" role="form" action="{{ route('admin.pelaporan_gratifikasi_data.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row col-md-6">
                                            ...
                                            <div class="form-group col-md-8 autocomplete">
                                                <textarea class="form-control" rows="6" name="pgd_pelapor_alamat_rumah" id="pgd_pelapor_alamat_rumah">{{ old('pgd_pelapor_alamat_rumah') ? old('pgd_pelapor_alamat_rumah') : '' }}</textarea>
                                            </div>
                                        </div>
                                        <div class="row col-md-6">
                                            <div class="col-md-4">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row col-md-6">
                                            <div class="col-md-4">
                                                <strong>Tempat Penerimaan</strong>
                                            </div>
                                            <div class="form-group col-md-8 autocomplete">
                                ...
                                <div class="box-footer">
                                    ...
                                    <a href="{{ route('admin.pelaporan_gratifikasi_form.index') }}" class="btn btn-warning">Batal</a>
