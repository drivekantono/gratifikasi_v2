...
<section class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong>Tambah Data Pengaduan Masyarakat</strong></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form name="formDumas" role="form" action="{{ route('admin.pengaduan_masyarakat_data.store') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        @if (count($errors) > 0)
                        ...
                        <fieldset>
                                ...
                                <div class="form-group col-md-3">
                                    <select id="pmd_sumber" name="pmd_sumber" class="form-control" onChange="pmd_sumber_change()">
                                        ...
                                        @foreach ($items_aduan_sumber as $item_aduan_sumber)
                                            <option value="{{ $item_aduan_sumber->pml_nilai }}" {{ ($item_aduan_sumber->pml_nilai === old('pmd_sumber')) ? 'selected' : '' }} >{{ $item_aduan_sumber->pml_nilai }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-1">
                                ...
                                <div class="form-group col-md-3">
                                    <select id="pmd_sifat" name="pmd_sifat" class="form-control" onChange="pmd_sifat_change()">
                                        ...
                                        @foreach ($items_aduan_sifat as $item_aduan_sifat)
                                            <option value="{{ $item_aduan_sifat->pml_nilai }}" {{ ($item_aduan_sifat->pml_nilai === old('pmd_sifat')) ? 'selected' : '' }} >{{ $item_aduan_sifat->pml_nilai }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                ...
                                <div class="form-group col-md-3 autocomplete">
                                    <input type="text" class="form-control" name="pmd_no" id="pmd_no" onKeyUp="showResults(this.value, 'No Surat')" value="{{ old('pmd_no') ? old('pmd_no') : '' }}" autocomplete="off">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="pmd_tanggal" name="pmd_tanggal" value="{{ old('pmd_tanggal') ? old('pmd_tanggal') : '' }}" autocomplete="off" readonly style="background-color: white;"> 
                                    </div>
                                </div>
                                <div class="col-md-1">
                                ...
                                <div class="form-group col-md-3">
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="pmd_tanggal_terima" name="pmd_tanggal_terima" value="{{ old('pmd_tanggal_terima') ? old('pmd_tanggal_terima') : '' }}" autocomplete="off" readonly style="background-color: white;">
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                ...
                                <div class="form-group col-md-11">
                                    <textarea type="text" class="form-control" id="pmd_pelapor_alamat" name="pmd_pelapor_alamat" rows="3">{{ old('pmd_pelapor_alamat') ? old('pmd_pelapor_alamat') : '' }}</textarea>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                ...
                                <div class="form-group col-md-3 autocomplete">
                                    <!-- <input type="text" class="form-control" id="pmd_terlapor_nama" name="pmd_terlapor_nama" onKeyUp="checkTerlaporNama(this.value)" value="{{ old('pmd_terlapor_nama') ? old('pmd_terlapor_nama') : '' }}"> -->
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="pmd_terlapor_nama" name="pmd_terlapor_nama" onKeyUp="showResults(this.value, 'Nama Terlapor')" value="{{ old('pmd_terlapor_nama') ? old('pmd_terlapor_nama') : '' }}" autocomplete="off">
                                        <div class="input-group-addon">
                            ...
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                ...
                                <div class="form-group col-md-11">
                                    <textarea type="text" class="form-control" id="pmd_terlapor_alamat" name="pmd_terlapor_alamat" rows="3">{{ old('pmd_terlapor_alamat') ? old('pmd_terlapor_alamat') : '' }}</textarea>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                ...
                                <div class="form-group col-md-11">
                                    <textarea type="text" class="form-control" id="pmd_isi" name="pmd_isi" rows="3">{{ old('pmd_isi') ? old('pmd_isi') : '' }}</textarea>
                                </div>
                            </div>
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                <div class="col-md-1">
                                ...
                                <div class="form-group col-md-11">
                                    <textarea type="text" class="form-control" id="pmd_harapan" name="pmd_harapan" rows="3">{{ old('pmd_harapan') ? old('pmd_harapan') : '' }}</textarea>
                                </div>
                            </div>
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                <div class="col-md-1">
                                ...
                                <div class="form-group col-md-11">
                                    <textarea type="text" class="form-control" id="pmd_catatan" name="pmd_catatan" rows="3">{{ old('pmd_catatan') ? old('pmd_catatan') : '' }}</textarea>
                                </div>
                            </div>
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                <div class="col-md-1">
                            ...
                            <div class="row" style="padding-left: 15px; padding-right: 15px;">
                                ...
                                <div class="form-group col-md-3">
                                    <input type="text" class="form-control" id="pmd_status" name="pmd_status" disabled value="Baru" style="background-color: #e4f5ff;">
                                </div>
                            </div>
                        </fieldset>
                    </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('admin.pengaduan_masyarakat_data.index') }}" class="btn btn-warning">Cancel</a>
    ...
    <div class="modal fade" id="modalscrollable" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <!-- Modal Header -->
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">Indikasi Nama Terlapor Sama</h4>
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
          </div>

          <!-- Modal body -->
          <div class="modal-body">
            <p>Terlapor Atas Nama </p><strong><span id="temp_pmd_terlapor_nama"></span></strong><p> Sepertinya Sudah Pernah Dilaporkan! Cek Terlebih Dahulu? Atau Yakin ingin tetap lanjutkan Tambah Data?</p> 
          </div>
...
<script>
    ...
    function check_pmd_terlapor_nama_click(temp_pmd_terlapor_nama) {
        var url_php = '{{ route('admin.pengaduan_masyarakat_data.popup', 'spliter') }}';
