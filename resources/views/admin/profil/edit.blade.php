    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.master.update', $items->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <td>
                            @if($items->images != null)
                                <img src="{{ asset('/uploads/profil/'.$items->images) }}" height="30%" width="30%" />
                            @else
                                <p>Tidak ada Image</p>
                            @endif
                        </td>
