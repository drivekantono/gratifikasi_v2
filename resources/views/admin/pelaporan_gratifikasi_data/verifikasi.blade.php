        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><strong>Verifikasi Data Laporan Gratifikasi | {{ $items->pgd_no }}</strong></h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <form name="formGratifikasi" role="form" action="{{ route('admin.pelaporan_gratifikasi_data.updateVerifikasi', $items->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        @if (count($errors) > 0)
                        ...
                        <fieldset>
                            <div class="row col-md-6" style="padding-left: 15px; padding-right: 15px;">
                                <div class="col-md-4">
                                    <strong>Hasil Verifikasi UPG</strong>
                                </div>
                                <div class="form-group col-md-8">
                                    <select id="pgd_verifikasi" name="pgd_verifikasi" class="form-control">
                                        <option value="" {{ ($items->pgd_verifikasi === '') ? 'selected' : '' }}></option>
                                        <option value="Lengkap" {{ ($items->pgd_verifikasi === 'Lengkap') ? 'selected' : '' }}>Lengkap</option>
                                        <option value="Belum Lengkap" {{ ($items->pgd_verifikasi === 'Belum Lengkap') ? 'selected' : '' }}>Belum Lengkap</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row col-md-12">
                                ...
                                <div class="form-group col-md-10 autocomplete" style="padding-left: 10px; padding-right: 45px;">
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary" title="submit perubahan data">Verifikasi</button>
