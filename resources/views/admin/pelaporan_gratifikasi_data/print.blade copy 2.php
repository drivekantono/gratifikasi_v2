            ...
            <table class="table2 withBorder font4">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="withBorder">:</td>
                        <td class="withBorder">{{ $items->pgd_tanggal }}</td>
                    </tr>
                    <tr>
                        <td class="withBorder text-right" style="width: 5%; padding-right: 4px;">5.</td>
                    ...
                    <tr>
                        ...
                        <td class="withBorder">:</td>
                        <td class="withBorder"><img src="{{asset('uploads/pelaporan_gratifikasi/'.$items->pgd_lampiran)}}" alt="Dokumen Pendukung" style="width:97%;"></td>
                    </tr>
                </tbody>
            </table>

            <h2 class="font4 bold">E. Penyaluran Objek Gratifikasi</h2>
            <table class="table2 withBorder font4">
                <tbody>
                    <tr>
                        <td class="withBorder text-right" style="width: 5%; padding-right: 4px;">1.</td>
                        <td class="withBorder" style="width: 38%;">Waktu Penyerahan</td>
                        <td class="withBorder" style="width: 4%;">:</td>
                        <td class="withBorder" style="width: 55%;">{{ $items->pgd_penyaluran_tanggal }}</td>
                    </tr>
                    <tr>
                        <td class="withBorder text-right" style="width: 5%; padding-right: 4px;">2.</td>
                        <td class="withBorder">Nama Penerima</td>
                        <td class="withBorder">:</td>
                        <td class="withBorder">{{ $items->pgd_penyaluran_nama }}</td>
                    </tr>
                    <tr>
                        <td class="withBorder text-right" style="width: 5%; padding-right: 4px;">3.</td>
                        <td class="withBorder">Alamat</td>
                        <td class="withBorder">:</td>
                        <td class="withBorder">{{ $items->pgd_penyaluran_alamat }}</td>
                    </tr>
                    <tr>
                        <td class="withBorder text-right" style="width: 5%; padding-right: 4px;">4.</td>
                        <td class="withBorder">Dokumentasi</td>
                        <td class="withBorder">:</td>
                        <td class="withBorder"><img src="{{asset('uploads/pelaporan_gratifikasi/'.$items->pgd_penyaluran_lampiran)}}" alt="Dokumentasi Penyaluran" style="width:97%;"></td>
                    </tr>
                </tbody>
            </table>
        </div>
