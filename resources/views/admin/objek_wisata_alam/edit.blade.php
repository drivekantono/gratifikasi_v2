    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form" action="{{ route('admin.objek_wisata_alam.update', $items->id) }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <td>
                            @if($items->images != null)
                                <img src="{{ asset('/uploads/objek_wisata_alam/'.$items->images) }}" height="30%" width="30%" />
                            @else
                                <p>Tidak ada Image</p>
                            @endif
                        </td>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ route('admin.objek_wisata_alam.index') }}" class="btn btn-success">Cancel</a>
