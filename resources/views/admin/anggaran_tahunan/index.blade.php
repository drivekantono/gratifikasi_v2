...
@section('content')
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Anggaran Tahunan</h3>
            </div>
            <div class="box-header">
              <a href="{{ route('admin.anggaran_tahunan.create') }}" class="btn btn-primary" style="margin-bottom: 15px;"><i class="fa fa-plus"></i>Tambah Data</a>  
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($items as $item)
                  <tr>
                    ...
                    <td>{{ $item->tahun }}</td>
                    <td><a href="{{asset('uploads/anggaran_tahunan/'.$item->file)}}"> Download File</a></td>
                    
                    <td>
                      <a href="{!! route('admin.anggaran_tahunan.edit', $item->id) !!}"><button class="btn btn-success"><i class="fa fa-edit"></i></button></a>
                    </td>
                    <td>
                      <form action="{{ route('admin.anggaran_tahunan.destroy', $item->id) }}" method="GET" style="display:inline-block;">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Anggaran Tahunan</h4>
              </div>
...
<script>
  ...
  function load_data(id){
    var url_php = '{{ route('admin.anggaran_tahunan.show', 'id') }}';
