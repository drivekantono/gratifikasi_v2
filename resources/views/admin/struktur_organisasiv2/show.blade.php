              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach ($items as $item)
                  <tr>
                    ...
                    <td>
                      <img src="{{ asset('/uploads/struktur_organisasi/'.$item->images) }}" height="50px" width="70px" />
                    </td>
                    <td>
                      <a href="{!! route('admin.struktur_organisasi2.edit', $item->id) !!}"><button class="btn btn-success"><i class="fa fa-edit"></i></button></a>
                      <form action="{{ route('admin.struktur_organisasi2.destroy', $item->id) }}" method="GET" style="display:inline-block;">
