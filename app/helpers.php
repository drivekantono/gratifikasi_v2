...
if (! function_exists('statusForm'))
{
	function statusForm($parm)
	{
		if($parm == 0){
			 ...
			 return "Konfirmasi UPT";
	 }elseif ($parm == 2) {
			 return "Konfirmasi Dinas";
	 }elseif ($parm == 3) {
			 return "Konfirmasi Kepala Dinas";
	 }elseif ($parm == 88) {
			 return "Revisi";
	 }elseif ($parm == 99) {
			 return "Tolak";
...
if (! function_exists('tglWaktuIndo'))
{
	function tglWaktuIndo($parm)
	{
		...
		return date('d',strtotime($parm))." ".$array_bulan[$dataBulan]." ".date('Y',strtotime($parm))." jam ".$dataWaktu." WIB";
	}
}
