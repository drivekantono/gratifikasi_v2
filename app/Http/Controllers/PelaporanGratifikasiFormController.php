...
class PelaporanGratifikasiFormController extends Controller
{
    public function index()
    {
        $perPage = 10;
        $items = PelaporanGratifikasiForm::orderBy('created_at', 'DESC')->get();
        $items_mobile = PelaporanGratifikasiForm::orderBy('created_at', 'DESC')->paginate($perPage);
        return view('admin.pelaporan_gratifikasi_form.index', compact('items', 'items_mobile', 'perPage'));
    }
